...
public class FlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
    ...
    private final a<u> windowInfoListener;
    ...
    public WindowInfoRepositoryCallbackAdapterWrapper createWindowInfoRepo() {
        try {
            return new WindowInfoRepositoryCallbackAdapterWrapper(new n1.a(q.f4654a.a(getContext())));
    ...
    public final WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (i10 >= 30) {
            ...
            this.viewportMetrics.viewPaddingTop = z11 ? windowInsets.getSystemWindowInsetTop() : 0;
            ...
            this.viewportMetrics.viewPaddingBottom = (!z10 || guessBottomKeyboardInset(windowInsets) != 0) ? 0 : windowInsets.getSystemWindowInsetBottom();
    ...
    public void onAttachedToWindow() {
        ...
        if (windowInfoRepositoryCallbackAdapterWrapper != null && activity != null) {
            windowInfoRepositoryCallbackAdapterWrapper.addWindowLayoutInfoListener(activity, androidx.core.content.a.i(getContext()), this.windowInfoListener);
        }
    }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        FlutterRenderer.ViewportMetrics viewportMetrics2 = this.viewportMetrics;
        viewportMetrics2.width = i10;
        viewportMetrics2.height = i11;
        sendViewportMetricsToFlutter();
    }
    ...
    public void sendUserSettingsToFlutter() {
        ...
        L_0x001c:
            ...
            io.flutter.embedding.android.a r4 = io.flutter.embedding.android.a.f15009a
    ...
    public void setVisibility(int i10) {
        ...
        if (renderSurface2 instanceof FlutterSurfaceView) {
            ((FlutterSurfaceView) renderSurface2).setVisibility(i10);
        }
    }
    ...
    public FlutterView(Context context, RenderMode renderMode) {
        ...
        this.windowInfoListener = new a<u>() {
            public void accept(u uVar) {
                FlutterView.this.setWindowInfoListenerDisplayFeatures(uVar);
            }
        };
    ...
    public FlutterView(Context context, RenderMode renderMode, TransparencyMode transparencyMode) {
        ...
        boolean z10 = false;
        if (renderMode == RenderMode.surface) {
            FlutterSurfaceView flutterSurfaceView2 = new FlutterSurfaceView(context, transparencyMode == TransparencyMode.transparent ? true : z10);
            this.flutterSurfaceView = flutterSurfaceView2;
            this.renderSurface = flutterSurfaceView2;
        } else if (renderMode == RenderMode.texture) {
            FlutterTextureView flutterTextureView2 = new FlutterTextureView(context);
