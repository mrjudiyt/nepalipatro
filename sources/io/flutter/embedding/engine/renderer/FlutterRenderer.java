...
public class FlutterRenderer implements TextureRegistry {
    ...
    public enum DisplayFeatureState {
        ...
        private DisplayFeatureState(int i10) {
    ...
    public enum DisplayFeatureType {
        ...
        private DisplayFeatureType(int i10) {
            this.encodedValue = i10;
        }
    }
    ...
    static final class SurfaceTextureFinalizerRunnable implements Runnable {
        ...
        SurfaceTextureFinalizerRunnable(long j10, FlutterJNI flutterJNI2) {
            this.id = j10;
    ...
    public void setViewportMetrics(ViewportMetrics viewportMetrics) {
        ...
        if (viewportMetrics.validate()) {
            ...
            for (int i10 = 0; i10 < viewportMetrics2.displayFeatures.size(); i10++) {
                DisplayFeature displayFeature = viewportMetrics2.displayFeatures.get(i10);
                int i11 = i10 * 4;
    ...
    public void startRenderingToSurface(Surface surface2, boolean z10) {
