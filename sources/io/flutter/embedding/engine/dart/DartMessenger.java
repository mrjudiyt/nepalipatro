...
class DartMessenger implements BinaryMessenger, PlatformMessageHandler {
    ...
    static class Reply implements BinaryMessenger.BinaryReply {
        ...
        Reply(FlutterJNI flutterJNI2, int i10) {
    ...
    private void dispatchMessageToQueue(String str, HandlerInfo handlerInfo, ByteBuffer byteBuffer, int i10, long j10) {
        ...
        a aVar = new a(this, str, i10, handlerInfo, byteBuffer, j10);
