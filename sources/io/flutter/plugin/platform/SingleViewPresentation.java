...
class SingleViewPresentation extends Presentation {
    ...
    public SingleViewPresentation(Context context, Display display, PlatformView platformView, AccessibilityEventsDelegate accessibilityEventsDelegate2, int i10, View.OnFocusChangeListener onFocusChangeListener) {
    ...
    public SingleViewPresentation(Context context, Display display, AccessibilityEventsDelegate accessibilityEventsDelegate2, PresentationState presentationState, View.OnFocusChangeListener onFocusChangeListener, boolean z10) {
        super(new ImmContext(context), display);
        this.accessibilityEventsDelegate = accessibilityEventsDelegate2;
        this.state = presentationState;
        this.focusChangeListener = onFocusChangeListener;
