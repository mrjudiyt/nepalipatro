    ...
    private final class IncomingMethodCallHandler implements BinaryMessenger.BinaryMessageHandler {
        ...
        public void onMessage(ByteBuffer byteBuffer, final BinaryMessenger.BinaryReply binaryReply) {
            try {
                ...
                binaryReply.reply(MethodChannel.this.codec.encodeErrorEnvelopeWithStacktrace("error", e10.getMessage(), (Object) null, Log.getStackTraceString(e10)));
            }
        }
    }
        ...
        public void reply(ByteBuffer byteBuffer) {
            if (byteBuffer == null) {
                ...
                try {
                    ...
                    this.callback.error(e11.code, e11.getMessage(), e11.details);
                }
            }
        }
    }
