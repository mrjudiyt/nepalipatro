...
class ListenableEditingState extends SpannableStringBuilder {
    ...
    public void endBatchEdit() {
        ...
        if (i10 == 1) {
            ...
            if (!this.mListeners.isEmpty()) {
                ...
                boolean z10 = false;
                boolean z11 = (this.mSelectionStartWhenBeginBatchEdit == getSelectionStart() && this.mSelectionEndWhenBeginBatchEdit == getSelectionEnd()) ? false : true;
                if (!(this.mComposingStartWhenBeginBatchEdit == getComposingStart() && this.mComposingEndWhenBeginBatchEdit == getComposingEnd())) {
                    z10 = true;
                }
                notifyListenersIfNeeded(equals, z11, z10);
            }
        }
    ...
    public SpannableStringBuilder replace(int i10, int i11, CharSequence charSequence, int i12, int i13) {
        ...
        boolean z13 = z12;
        int i16 = composingEnd;
        TextEditingDelta textEditingDelta2 = new TextEditingDelta(listenableEditingState, i10, i11, charSequence, getSelectionStart(), getSelectionEnd(), getComposingStart(), getComposingEnd());
        ...
        if (getComposingStart() == composingStart && getComposingEnd() == i16) {
            z10 = z13;
            z11 = false;
        } else {
            z10 = z13;
