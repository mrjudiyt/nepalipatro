...
public class FlutterFirebaseCorePlugin implements FlutterPlugin, GeneratedAndroidFirebaseCore.FirebaseCoreHostApi, GeneratedAndroidFirebaseCore.FirebaseAppHostApi {
    ...
    public /* synthetic */ void lambda$initializeApp$2(io.flutter.plugins.firebase.core.GeneratedAndroidFirebaseCore.PigeonFirebaseOptions r3, java.lang.String r4, com.google.android.gms.tasks.TaskCompletionSource r5) {
        /*
            r2 = this;
            com.google.firebase.FirebaseOptions$Builder r0 = new com.google.firebase.FirebaseOptions$Builder     // Catch:{ Exception -> 0x0067 }
            r0.<init>()     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getApiKey()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setApiKey(r1)     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getAppId()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setApplicationId(r1)     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getDatabaseURL()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setDatabaseUrl(r1)     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getMessagingSenderId()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setGcmSenderId(r1)     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getProjectId()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setProjectId(r1)     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getStorageBucket()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setStorageBucket(r1)     // Catch:{ Exception -> 0x0067 }
            java.lang.String r1 = r3.getTrackingId()     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions$Builder r0 = r0.setGaTrackingId(r1)     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseOptions r0 = r0.build()     // Catch:{ Exception -> 0x0067 }
            android.os.Looper.prepare()     // Catch:{ Exception -> 0x0044 }
        L_0x0044:
            java.lang.String r1 = r3.getAuthDomain()     // Catch:{ Exception -> 0x0067 }
            if (r1 == 0) goto L_0x0053
            java.util.Map<java.lang.String, java.lang.String> r1 = customAuthDomain     // Catch:{ Exception -> 0x0067 }
            java.lang.String r3 = r3.getAuthDomain()     // Catch:{ Exception -> 0x0067 }
            r1.put(r4, r3)     // Catch:{ Exception -> 0x0067 }
        L_0x0053:
            android.content.Context r3 = r2.applicationContext     // Catch:{ Exception -> 0x0067 }
            com.google.firebase.FirebaseApp r3 = com.google.firebase.FirebaseApp.initializeApp(r3, r0, r4)     // Catch:{ Exception -> 0x0067 }
            com.google.android.gms.tasks.Task r3 = r2.firebaseAppToMap(r3)     // Catch:{ Exception -> 0x0067 }
            java.lang.Object r3 = com.google.android.gms.tasks.Tasks.await(r3)     // Catch:{ Exception -> 0x0067 }
            io.flutter.plugins.firebase.core.GeneratedAndroidFirebaseCore$PigeonInitializeResponse r3 = (io.flutter.plugins.firebase.core.GeneratedAndroidFirebaseCore.PigeonInitializeResponse) r3     // Catch:{ Exception -> 0x0067 }
