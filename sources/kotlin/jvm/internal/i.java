...
public class i extends c implements h, e {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof i) {
            i iVar = (i) obj;
            if (!getName().equals(iVar.getName()) || !getSignature().equals(iVar.getSignature()) || this.flags != iVar.flags || this.arity != iVar.arity || !m.a(getBoundReceiver(), iVar.getBoundReceiver()) || !m.a(getOwner(), iVar.getOwner())) {
                return false;
            }
            return true;
