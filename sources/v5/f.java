...
final class f {
    public static void a(Spannable spannable, int i10, int i11, g gVar, d dVar, Map<String, g> map, int i12) {
        ...
        if (j10 == 2) {
            ...
            if (!(d10 == null || (e10 = e(d10, map)) == null)) {
                if (e10.g() != 1 || e10.f(0).f12435b == null) {
                    p.f("TtmlRenderUtil", "Skipping rubyText node without exactly one text child.");
                } else {
                    String str = (String) m0.j(e10.f(0).f12435b);
                    g f11 = f(e10.f12439f, e10.l(), map);
                    int i16 = f11 != null ? f11.i() : -1;
                    if (i16 == -1 && (f10 = f(d10.f12439f, d10.l(), map)) != null) {
                        i16 = f10.i();
                    }
        ...
        if (gVar.n()) {
            c.a(spannable, new s5.a(), i10, i11, 33);
        }
        int f12 = gVar.f();
        if (f12 == 1) {
    ...
    private static d d(d dVar, Map<String, g> map) {
        while (dVar != null) {
            g f10 = f(dVar.f12439f, dVar.l(), map);
            if (f10 != null && f10.j() == 1) {
                return dVar;
            }
            dVar = dVar.f12443j;
    ...
    private static d e(d dVar, Map<String, g> map) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            g f10 = f(dVar2.f12439f, dVar2.l(), map);
            if (f10 != null && f10.j() == 3) {
                return dVar2;
            }
