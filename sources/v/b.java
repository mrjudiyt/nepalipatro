...
public class b {
    ...
    static void a(v.f r38, s.d r39, int r40, int r41, v.c r42) {
        ...
        L_0x01ba:
            r0 = r42
            java.util.ArrayList<v.e> r1 = r0.f12108h
            if (r1 == 0) goto L_0x026b
            int r2 = r1.size()
            r3 = 1
            if (r2 <= r3) goto L_0x026b
            boolean r4 = r0.f12118r
            if (r4 == 0) goto L_0x01d3
            boolean r4 = r0.f12120t
            if (r4 != 0) goto L_0x01d3
            int r4 = r0.f12110j
            float r4 = (float) r4
            goto L_0x01d5
        ...
        L_0x029b:
            ...
            r2 = r24
            float r2 = r2.f12172o0
            goto L_0x02aa
        L_0x02a6:
            r2 = r24
            float r2 = r2.f12174p0
        L_0x02aa:
            r4 = r2
            int r6 = r0.e()
            int r7 = r1.e()
    ...
    public static void b(f fVar, d dVar, ArrayList<e> arrayList, int i10) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            c cVar = cVarArr[i14];
            cVar.a();
            if (arrayList == null || arrayList.contains(cVar.f12101a)) {
