...
public class e {
    ...
    public float f12150d0;

    /* renamed from: e  reason: collision with root package name */
    public l f12151e = null;

    /* renamed from: e0  reason: collision with root package name */
    protected int f12152e0;

    /* renamed from: f  reason: collision with root package name */
    public n f12153f = null;

    /* renamed from: f0  reason: collision with root package name */
    protected int f12154f0;

    /* renamed from: g  reason: collision with root package name */
    public boolean[] f12155g = {true, true};

    /* renamed from: g0  reason: collision with root package name */
    protected int f12156g0;

    /* renamed from: h  reason: collision with root package name */
    boolean f12157h = false;

    /* renamed from: h0  reason: collision with root package name */
    int f12158h0;

    /* renamed from: i  reason: collision with root package name */
    private boolean f12159i = true;
    ...
    protected int f12162j0;

    /* renamed from: k  reason: collision with root package name */
    private boolean f12163k = true;

    /* renamed from: k0  reason: collision with root package name */
    protected int f12164k0;

    /* renamed from: l  reason: collision with root package name */
    private int f12165l = -1;
    ...
    protected int f12168m0;

    /* renamed from: n  reason: collision with root package name */
    public u.a f12169n = new u.a(this);

    /* renamed from: n0  reason: collision with root package name */
    protected int f12170n0;
    ...
    public int f12189x = 0;

    /* renamed from: x0  reason: collision with root package name */
    boolean f12190x0;

    /* renamed from: y  reason: collision with root package name */
    public int[] f12191y = new int[2];

    /* renamed from: y0  reason: collision with root package name */
    boolean f12192y0;

    /* renamed from: z  reason: collision with root package name */
    public int f12193z = 0;
    ...
    private void N(StringBuilder sb, String str, int i10, int i11, int i12, int i13, int i14, int i15, float f10, float f11) {
        sb.append(str);
        sb.append(" :  {\n");
        v0(sb, "      size", i10, 0);
        v0(sb, "      min", i11, 0);
        v0(sb, "      max", i12, Api.BaseClientBuilder.API_PRIORITY_OTHER);
        v0(sb, "      matchMin", i14, 0);
        v0(sb, "      matchDef", i15, 0);
        u0(sb, "      matchPercent", f10, 1.0f);
        sb.append("    },\n");
    }

    private void O(StringBuilder sb, String str, d dVar) {
        if (dVar.f12128f != null) {
            sb.append("    ");
            sb.append(str);
            sb.append(" : [ '");
            sb.append(dVar.f12128f);
            sb.append("'");
            if (!(dVar.f12130h == Integer.MIN_VALUE && dVar.f12129g == 0)) {
                sb.append(",");
                sb.append(dVar.f12129g);
                if (dVar.f12130h != Integer.MIN_VALUE) {
                    sb.append(",");
                    sb.append(dVar.f12130h);
                    sb.append(",");
                }
            }
            sb.append(" ] ,\n");
    ...
    private boolean d0(int i10) {
        int i11 = i10 * 2;
        d[] dVarArr = this.W;
        if (!(dVarArr[i11].f12128f == null || dVarArr[i11].f12128f.f12128f == dVarArr[i11])) {
            int i12 = i11 + 1;
            return dVarArr[i12].f12128f != null && dVarArr[i12].f12128f.f12128f == dVarArr[i12];
        }
    }
    ...
    private void i(s.d r37, boolean r38, boolean r39, boolean r40, boolean r41, s.i r42, s.i r43, v.e.b r44, boolean r45, v.d r46, v.d r47, int r48, int r49, int r50, int r51, float r52, boolean r53, boolean r54, boolean r55, boolean r56, boolean r57, int r58, int r59, int r60, int r61, float r62, boolean r63) {
        ...
        L_0x020d:
            ...
            boolean r1 = r0.f12161j
            if (r1 == 0) goto L_0x0235
            boolean r1 = r9.f11265n
            if (r1 == 0) goto L_0x0235
            v.e r1 = r0.f12144a0
            if (r1 == 0) goto L_0x0235
            v.f r1 = (v.f) r1
        ...
        L_0x023d:
            ...
            boolean r1 = r2.f11265n
            if (r1 == 0) goto L_0x0275
            boolean r1 = r15.f11265n
            if (r1 == 0) goto L_0x0275
            int r1 = r46.e()
            r4 = 8
            r10.e(r9, r2, r1, r4)
        ...
        L_0x0533:
            ...
            boolean r2 = r0.f12161j
            if (r2 == 0) goto L_0x054f
            boolean r2 = r14.f11265n
            if (r2 == 0) goto L_0x054f
            v.e r2 = r0.f12144a0
            if (r2 == 0) goto L_0x054f
            v.f r2 = (v.f) r2
    ...
    private void u0(StringBuilder sb, String str, float f10, float f11) {
        if (f10 != f11) {
            sb.append(str);
            sb.append(" :   ");
            sb.append(f10);
    ...
    private void v0(StringBuilder sb, String str, int i10, int i11) {
        if (i10 != i11) {
            sb.append(str);
            sb.append(" :   ");
            sb.append(i10);
    ...
    private void w0(StringBuilder sb, String str, float f10, int i10) {
        if (f10 != 0.0f) {
            sb.append(str);
            sb.append(" :  [");
            sb.append(f10);
    ...
    public void B0(int i10) {
        if (this.J) {
            int i11 = i10 - this.f12166l0;
            int i12 = this.f12148c0 + i11;
            this.f12156g0 = i11;
            this.P.s(i11);
            this.R.s(i12);
            this.S.s(i10);
    ...
    public void F0(int i10, int i11) {
        if (!this.f12175q) {
            ...
            this.R.s(i11);
            this.f12156g0 = i10;
            this.f12148c0 = i11 - i10;
            if (this.J) {
                this.S.s(i10 + this.f12166l0);
            }
            this.f12175q = true;
        }
    }
    ...
    public void G0(int i10, int i11, int i12, int i13) {
        ...
        b bVar = bVarArr[0];
        b bVar2 = b.FIXED;
        if (bVar == bVar2 && i16 < (i15 = this.f12146b0)) {
            i16 = i15;
        }
        if (bVarArr[1] == bVar2 && i17 < (i14 = this.f12148c0)) {
            i17 = i14;
        }
        this.f12146b0 = i16;
        this.f12148c0 = i17;
        int i18 = this.f12170n0;
        if (i17 < i18) {
            this.f12148c0 = i18;
        }
        int i19 = this.f12168m0;
        if (i16 < i19) {
            this.f12146b0 = i19;
        }
        int i20 = this.A;
        if (i20 > 0 && bVarArr[0] == b.MATCH_CONSTRAINT) {
            this.f12146b0 = Math.min(this.f12146b0, i20);
        }
        int i21 = this.D;
        if (i21 > 0 && this.Z[1] == b.MATCH_CONSTRAINT) {
            this.f12148c0 = Math.min(this.f12148c0, i21);
        }
        int i22 = this.f12146b0;
        if (i16 != i22) {
            this.f12165l = i22;
        }
        int i23 = this.f12148c0;
        if (i17 != i23) {
            this.f12167m = i23;
        }
    }
    ...
    public void M(StringBuilder sb) {
        ...
        sb2.append(this.f12146b0);
        sb.append(sb2.toString());
        sb.append("\n");
        sb.append("    actualHeight:" + this.f12148c0);
        sb.append("\n");
        sb.append("    actualLeft:" + this.f12154f0);
        sb.append("\n");
        sb.append("    actualTop:" + this.f12156g0);
        sb.append("\n");
        O(sb, ViewHierarchyConstants.DIMENSION_LEFT_KEY, this.O);
        O(sb, ViewHierarchyConstants.DIMENSION_TOP_KEY, this.P);
        O(sb, "right", this.Q);
        O(sb, "bottom", this.R);
        O(sb, "baseline", this.S);
        O(sb, "centerX", this.T);
        O(sb, "centerY", this.U);
        N(sb, "    width", this.f12146b0, this.f12168m0, this.H[0], this.f12165l, this.f12193z, this.f12187w, this.B, this.D0[0]);
        N(sb, "    height", this.f12148c0, this.f12170n0, this.H[1], this.f12167m, this.C, this.f12189x, this.E, this.D0[1]);
        w0(sb, "    dimensionRatio", this.f12150d0, this.f12152e0);
        u0(sb, "    horizontalBias", this.f12172o0, K0);
        u0(sb, "    verticalBias", this.f12174p0, K0);
        v0(sb, "    horizontalChainStyle", this.f12194z0, 0);
    ...
    public int S() {
        int i10 = 0;
        if (this.O != null) {
            i10 = 0 + this.P.f12129g;
        }
        return this.Q != null ? i10 + this.R.f12129g : i10;
    }
    ...
    public int V() {
        e eVar = this.f12144a0;
        if (eVar == null || !(eVar instanceof f)) {
            return this.f12154f0;
        }
        return ((f) eVar).S0 + this.f12154f0;
    }
    ...
    public int W() {
        ...
        return ((f) eVar).T0 + this.f12156g0;
    }
    ...
    public boolean Y(int i10) {
        if (i10 == 0) {
            return (this.O.f12128f != null ? 1 : 0) + (this.Q.f12128f != null ? 1 : 0) < 2;
        }
        if ((this.P.f12128f != null ? 1 : 0) + (this.R.f12128f != null ? 1 : 0) + (this.S.f12128f != null ? 1 : 0) < 2) {
            return true;
        }
        return false;
    }
    ...
    public boolean a0() {
        return (this.f12165l == -1 && this.f12167m == -1) ? false : true;
    }
    ...
    public boolean b0(int i10, int i11) {
        ...
        d dVar2;
        if (i10 == 0) {
            d dVar3 = this.O.f12128f;
            if (dVar3 == null || !dVar3.m() || (dVar2 = this.Q.f12128f) == null || !dVar2.m() || (this.Q.f12128f.d() - this.Q.e()) - (this.O.f12128f.d() + this.O.e()) < i11) {
                return false;
            }
            return true;
        }
        d dVar4 = this.P.f12128f;
        if (dVar4 == null || !dVar4.m() || (dVar = this.R.f12128f) == null || !dVar.m() || (this.R.f12128f.d() - this.R.e()) - (this.P.f12128f.d() + this.P.e()) < i11) {
            return false;
        }
        return true;
        return false;
    ...
    public void e(f fVar, s.d dVar, HashSet<e> hashSet, int i10, boolean z10) {
        ...
        if (i10 == 0) {
            ...
            if (c10 != null) {
                ...
                while (it.hasNext()) {
                    it.next().f12126d.e(fVar, dVar, hashSet, i10, true);
                }
            }
            ...
            if (c11 != null) {
                ...
                while (it2.hasNext()) {
                    it2.next().f12126d.e(fVar, dVar, hashSet, i10, true);
                }
                return;
            }
            return;
        ...
        if (c12 != null) {
            ...
            while (it3.hasNext()) {
                it3.next().f12126d.e(fVar, dVar, hashSet, i10, true);
            }
        }
        ...
        if (c13 != null) {
            ...
            while (it4.hasNext()) {
                it4.next().f12126d.e(fVar, dVar, hashSet, i10, true);
            }
        }
        ...
        if (c14 != null) {
            ...
            while (it5.hasNext()) {
                it5.next().f12126d.e(fVar, dVar, hashSet, i10, true);
            }
        }
    }
    ...
    public void g(s.d r54, boolean r55) {
        ...
        L_0x0056:
            ...
            return
        L_0x0071:
            boolean r0 = r15.f12173p
            r2 = 5
            if (r0 != 0) goto L_0x007a
            boolean r8 = r15.f12175q
    ...
    public boolean g0() {
        ...
        if (dVar2 != null && dVar2.f12128f == dVar) {
            return true;
        }
        d dVar3 = this.Q;
        d dVar4 = dVar3.f12128f;
        return dVar4 != null && dVar4.f12128f == dVar3;
    }
    ...
    public boolean k0() {
        return this.f12159i && this.f12180s0 != 8;
    }
    ...
    public void l() {
        if (this.f12151e == null) {
            this.f12151e = new l(this);
        }
        if (this.f12153f == null) {
            this.f12153f = new n(this);
        }
    }

    public boolean l0() {
        return this.f12173p || (this.O.m() && this.Q.m());
    }
    ...
    public boolean m0() {
        return this.f12175q || (this.P.m() && this.R.m());
    }

    public void m1(boolean z10, boolean z11) {
        int i10;
        int i11;
        boolean k10 = z10 & this.f12151e.k();
        boolean k11 = z11 & this.f12153f.k();
        l lVar = this.f12151e;
        int i12 = lVar.f12568h.f12514g;
        n nVar = this.f12153f;
        int i13 = nVar.f12568h.f12514g;
        int i14 = lVar.f12569i.f12514g;
        int i15 = nVar.f12569i.f12514g;
        int i16 = i15 - i13;
        ...
        if (k10) {
            if (this.Z[0] == b.FIXED && i17 < (i11 = this.f12146b0)) {
                i17 = i11;
            }
            this.f12146b0 = i17;
            int i19 = this.f12168m0;
        ...
        if (k11) {
            if (this.Z[1] == b.FIXED && i18 < (i10 = this.f12148c0)) {
                i18 = i10;
            }
            this.f12148c0 = i18;
            int i20 = this.f12170n0;
            if (i18 < i20) {
                this.f12148c0 = i20;
            }
        }
    ...
    public void n1(s.d dVar, boolean z10) {
        ...
        if (z10 && (lVar = this.f12151e) != null) {
            f fVar = lVar.f12568h;
            if (fVar.f12517j) {
                f fVar2 = lVar.f12569i;
                if (fVar2.f12517j) {
                    x10 = fVar.f12514g;
                    x12 = fVar2.f12514g;
                }
        ...
        if (z10 && (nVar = this.f12153f) != null) {
            f fVar3 = nVar.f12568h;
            if (fVar3.f12517j) {
                f fVar4 = nVar.f12569i;
                if (fVar4.f12517j) {
                    x11 = fVar3.f12514g;
                    x13 = fVar4.f12514g;
                }
    ...
    public String toString() {
        ...
        String str2 = "";
        if (this.f12186v0 != null) {
            str = "type: " + this.f12186v0 + " ";
        } else {
            str = str2;
        }
        sb.append(str);
        if (this.f12184u0 != null) {
            str2 = "id: " + this.f12184u0 + " ";
        }
        sb.append(str2);
        sb.append("(");
        sb.append(this.f12154f0);
        sb.append(", ");
        sb.append(this.f12156g0);
        sb.append(") - (");
        sb.append(this.f12146b0);
        sb.append(" x ");
        sb.append(this.f12148c0);
        sb.append(")");
        return sb.toString();
    }
    ...
    public int z() {
        ...
        d dVar2 = this.Q;
        return dVar2 != null ? i10 + dVar2.f12129g : i10;
    }
