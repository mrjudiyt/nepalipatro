...
public final class c {
    ...
    private static final s f14552a = new s("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                    f14552a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
                    for (Signature byteArray : signatureArr) {
                        String a10 = b.a(byteArray.toByteArray());
