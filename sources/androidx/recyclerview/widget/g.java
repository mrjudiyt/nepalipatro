...
class g {
    ...
    private void c(List<a.b> list, int i10, a.b bVar, int i11, a.b bVar2) {
        ...
        if (i13 <= i15) {
            bVar.f4195b = i15 + bVar2.f4197d;
        }
        int i16 = bVar2.f4195b;
        if (i16 <= i12) {
            bVar.f4197d = i12 + bVar2.f4197d;
        }
        bVar2.f4195b = i16 + i14;
        list.set(i10, bVar2);
        list.set(i11, bVar);
    }
    ...
    public void e(java.util.List<androidx.recyclerview.widget.a.b> r10, int r11, androidx.recyclerview.widget.a.b r12, int r13, androidx.recyclerview.widget.a.b r14) {
        ...
        L_0x002e:
            ...
            r10.remove(r13)
            androidx.recyclerview.widget.g$a r10 = r9.f4306a
            r10.a(r14)
        L_0x0046:
            return
        L_0x0047:
        ...
        L_0x0052:
            ...
            int r4 = r4 + r7
            int r4 = r4 - r1
            androidx.recyclerview.widget.g$a r7 = r9.f4306a
            int r1 = r1 + r3
    ...
    public void f(java.util.List<androidx.recyclerview.widget.a.b> r9, int r10, androidx.recyclerview.widget.a.b r11, int r12, androidx.recyclerview.widget.a.b r13) {
        ...
        L_0x000d:
            ...
            int r5 = r5 - r4
            r13.f4197d = r5
            androidx.recyclerview.widget.g$a r0 = r8.f4306a
            int r1 = r11.f4195b
            java.lang.Object r5 = r13.f4196c
        ...
        L_0x002b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.g$a r3 = r8.f4306a
            int r1 = r1 + r4
            java.lang.Object r4 = r13.f4196c
        ...
        L_0x004c:
            r9.remove(r10)
            androidx.recyclerview.widget.g$a r11 = r8.f4306a
            r11.a(r13)
        L_0x0054:
