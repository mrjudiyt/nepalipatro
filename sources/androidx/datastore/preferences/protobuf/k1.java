...
abstract class k1<T, B> {
    ...
    public final void l(B r3, androidx.datastore.preferences.protobuf.d1 r4) {
        /*
            r2 = this;
        L_0x0000:
            int r0 = r4.A()
        ...
        L_0x000f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.k1.l(java.lang.Object, androidx.datastore.preferences.protobuf.d1):void");
    }

    /* access modifiers changed from: package-private */
    public final boolean m(B b10, d1 d1Var) {
        int a10 = d1Var.a();
        int a11 = q1.a(a10);
        int b11 = q1.b(a10);
        if (b11 == 0) {
    ...
    /* access modifiers changed from: package-private */
    public abstract void s(T t10, r1 r1Var);

    /* access modifiers changed from: package-private */
    public abstract void t(T t10, r1 r1Var);
}
