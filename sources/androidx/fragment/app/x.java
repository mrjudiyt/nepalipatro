...
class x {
    ...
    static final z f3335b = (Build.VERSION.SDK_INT >= 21 ? new y() : null);

    /* renamed from: c  reason: collision with root package name */
    static final z f3336c = w();

    /* compiled from: FragmentTransition */
    class a implements Runnable {

        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ g f3337h;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Fragment f3338i;

        /* renamed from: j  reason: collision with root package name */
        final /* synthetic */ androidx.core.os.f f3339j;

        a(g gVar, Fragment fragment, androidx.core.os.f fVar) {
            this.f3337h = gVar;
            this.f3338i = fragment;
            this.f3339j = fVar;
        }

        public void run() {
            this.f3337h.a(this.f3338i, this.f3339j);
        }
    }
    ...
    class b implements Runnable {
        ...
        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ ArrayList f3340h;
    ...
    class c implements Runnable {
        ...
        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ g f3341h;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Fragment f3342i;

        /* renamed from: j  reason: collision with root package name */
        final /* synthetic */ androidx.core.os.f f3343j;
        ...
        public void run() {
            this.f3341h.a(this.f3342i, this.f3343j);
        }
    }
    ...
    class d implements Runnable {
        ...
        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ Object f3344h;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ z f3345i;

        /* renamed from: j  reason: collision with root package name */
        final /* synthetic */ View f3346j;

        /* renamed from: k  reason: collision with root package name */
        final /* synthetic */ Fragment f3347k;

        /* renamed from: l  reason: collision with root package name */
        final /* synthetic */ ArrayList f3348l;

        /* renamed from: m  reason: collision with root package name */
        final /* synthetic */ ArrayList f3349m;

        /* renamed from: n  reason: collision with root package name */
        final /* synthetic */ ArrayList f3350n;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ Object f3351o;
        ...
        d(Object obj, z zVar, View view, Fragment fragment, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, Object obj2) {
            ...
            this.f3345i = zVar;
            this.f3346j = view;
            this.f3347k = fragment;
            this.f3348l = arrayList;
            this.f3349m = arrayList2;
            this.f3350n = arrayList3;
            this.f3351o = obj2;
        }
        ...
        public void run() {
            ...
            if (obj != null) {
                this.f3345i.p(obj, this.f3346j);
                this.f3349m.addAll(x.k(this.f3345i, this.f3344h, this.f3347k, this.f3348l, this.f3346j));
            }
            if (this.f3350n != null) {
                if (this.f3351o != null) {
                    ArrayList arrayList = new ArrayList();
                    arrayList.add(this.f3346j);
                    this.f3345i.q(this.f3351o, this.f3350n, arrayList);
                }
                this.f3350n.clear();
                this.f3350n.add(this.f3346j);
            }
        }
    }
    ...
    class e implements Runnable {
        ...
        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ Fragment f3352h;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Fragment f3353i;

        /* renamed from: j  reason: collision with root package name */
        final /* synthetic */ boolean f3354j;

        /* renamed from: k  reason: collision with root package name */
        final /* synthetic */ androidx.collection.a f3355k;

        /* renamed from: l  reason: collision with root package name */
        final /* synthetic */ View f3356l;

        /* renamed from: m  reason: collision with root package name */
        final /* synthetic */ z f3357m;

        /* renamed from: n  reason: collision with root package name */
        final /* synthetic */ Rect f3358n;

        e(Fragment fragment, Fragment fragment2, boolean z10, androidx.collection.a aVar, View view, z zVar, Rect rect) {
            this.f3352h = fragment;
            this.f3353i = fragment2;
            this.f3354j = z10;
            this.f3355k = aVar;
            this.f3356l = view;
            this.f3357m = zVar;
        ...
        public void run() {
            x.f(this.f3352h, this.f3353i, this.f3354j, this.f3355k, false);
            View view = this.f3356l;
            if (view != null) {
                this.f3357m.k(view, this.f3358n);
            }
        }
    }
    ...
    class f implements Runnable {
        ...
        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ z f3359h;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ androidx.collection.a f3360i;

        /* renamed from: j  reason: collision with root package name */
        final /* synthetic */ Object f3361j;

        /* renamed from: k  reason: collision with root package name */
        final /* synthetic */ h f3362k;

        /* renamed from: l  reason: collision with root package name */
        final /* synthetic */ ArrayList f3363l;

        /* renamed from: m  reason: collision with root package name */
        final /* synthetic */ View f3364m;

        /* renamed from: n  reason: collision with root package name */
        final /* synthetic */ Fragment f3365n;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ Fragment f3366o;

        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ boolean f3367p;

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ ArrayList f3368q;

        /* renamed from: r  reason: collision with root package name */
        final /* synthetic */ Object f3369r;

        /* renamed from: s  reason: collision with root package name */
        final /* synthetic */ Rect f3370s;
        ...
        f(z zVar, androidx.collection.a aVar, Object obj, h hVar, ArrayList arrayList, View view, Fragment fragment, Fragment fragment2, boolean z10, ArrayList arrayList2, Object obj2, Rect rect) {
            ...
            this.f3361j = obj;
            this.f3362k = hVar;
            this.f3363l = arrayList;
            this.f3364m = view;
            this.f3365n = fragment;
            this.f3366o = fragment2;
            this.f3367p = z10;
            this.f3368q = arrayList2;
            this.f3369r = obj2;
            this.f3370s = rect;
        }

        public void run() {
            androidx.collection.a<String, View> h10 = x.h(this.f3359h, this.f3360i, this.f3361j, this.f3362k);
            if (h10 != null) {
                this.f3363l.addAll(h10.values());
                this.f3363l.add(this.f3364m);
            }
            x.f(this.f3365n, this.f3366o, this.f3367p, h10, false);
            Object obj = this.f3361j;
            if (obj != null) {
                this.f3359h.A(obj, this.f3368q, this.f3363l);
                View s10 = x.s(h10, this.f3362k, this.f3369r, this.f3367p);
                if (s10 != null) {
                    this.f3359h.k(s10, this.f3370s);
                }
            }
        }
    }
    ...
    private static void a(ArrayList<View> arrayList, androidx.collection.a<String, View> aVar, Collection<String> collection) {
        for (int size = aVar.size() - 1; size >= 0; size--) {
            ...
            if (collection.contains(z.y(m10))) {
                arrayList.add(m10);
            }
        }
    }
    ...
    private static void b(androidx.fragment.app.a r8, androidx.fragment.app.w.a r9, android.util.SparseArray<androidx.fragment.app.x.h> r10, boolean r11, boolean r12) {
        ...
        L_0x00a4:
            ...
            androidx.fragment.app.Fragment r3 = r5.f3374d
            if (r3 != r0) goto L_0x00b1
            r5.f3374d = r2
        L_0x00b1:
            boolean r3 = r8.f3324r
            if (r3 != 0) goto L_0x00c5
            androidx.fragment.app.n r3 = r8.f3079t
        ...
        L_0x00d7:
            ...
            androidx.fragment.app.Fragment r8 = r5.f3371a
    ...
    public static void c(a aVar, SparseArray<h> sparseArray, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            b(aVar, aVar.f3309c.get(i10), sparseArray, false, z10);
        }
    }
    ...
    private static androidx.collection.a<String, String> d(int i10, ArrayList<a> arrayList, ArrayList<Boolean> arrayList2, int i11, int i12) {
        ...
        for (int i13 = i12 - 1; i13 >= i11; i13--) {
            ...
            if (aVar2.v(i10)) {
                ...
                ArrayList<String> arrayList5 = aVar2.f3322p;
                if (arrayList5 != null) {
                    int size = arrayList5.size();
                    if (booleanValue) {
                        arrayList3 = aVar2.f3322p;
                        arrayList4 = aVar2.f3323q;
                    } else {
                        ArrayList<String> arrayList6 = aVar2.f3322p;
                        arrayList3 = aVar2.f3323q;
    ...
    public static void e(a aVar, SparseArray<h> sparseArray, boolean z10) {
        if (aVar.f3079t.o0().d()) {
            for (int size = aVar.f3309c.size() - 1; size >= 0; size--) {
                b(aVar, aVar.f3309c.get(size), sparseArray, true, z10);
            }
        }
    }
    ...
    static androidx.collection.a<String, View> h(z zVar, androidx.collection.a<String, String> aVar, Object obj, h hVar) {
        ...
        if (hVar.f3372b) {
            ...
            arrayList = aVar3.f3322p;
        } else {
            fragment.getEnterTransitionCallback();
            arrayList = aVar3.f3323q;
        }
        if (arrayList != null) {
            aVar2.o(arrayList);
            aVar2.o(aVar.values());
    ...
    private static Object l(z zVar, ViewGroup viewGroup, View view, androidx.collection.a<String, String> aVar, h hVar, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        if (obj4 != null) {
            ...
            z(zVar, obj4, obj2, i10, hVar2.f3375e, hVar2.f3376f);
            if (obj5 != null) {
                zVar2.u(obj5, rect);
            }
        } else {
    ...
    private static Object m(z zVar, ViewGroup viewGroup, View view, androidx.collection.a<String, String> aVar, h hVar, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        v.a(viewGroup, new e(fragment, fragment2, z10, h10, view2, zVar, rect));
        return obj4;
    }
    ...
    private static void n(ViewGroup viewGroup, h hVar, View view, androidx.collection.a<String, String> aVar, g gVar) {
        ...
        if (j10 != null) {
            ...
            Object obj4 = obj;
            zVar.a(obj3, view2);
            Object u10 = u(zVar, obj3, obj4, l10, fragment, hVar2.f3372b);
            if (!(fragment2 == null || k10 == null || (k10.size() <= 0 && arrayList4.size() <= 0))) {
                androidx.core.os.f fVar = new androidx.core.os.f();
                gVar2.b(fragment2, fVar);
                zVar.w(fragment2, u10, fVar, new c(gVar2, fragment2, fVar));
            }
            if (u10 != null) {
    ...
    private static void o(ViewGroup viewGroup, h hVar, View view, androidx.collection.a<String, String> aVar, g gVar) {
        ...
        if (j10 != null) {
            ...
            if (!(fragment2 == null || arrayList4 == null || (arrayList4.size() <= 0 && arrayList3.size() <= 0))) {
                androidx.core.os.f fVar = new androidx.core.os.f();
                g gVar3 = gVar;
                gVar3.b(fragment2, fVar);
                j10.w(fragment2, u10, fVar, new a(gVar3, fragment2, fVar));
            }
            if (u10 != null) {
    ...
    static View s(androidx.collection.a<String, View> aVar, h hVar, Object obj, boolean z10) {
        ...
        String str;
        a aVar2 = hVar.f3373c;
        if (obj == null || aVar == null || (arrayList = aVar2.f3322p) == null || arrayList.isEmpty()) {
            return null;
        }
        if (z10) {
            str = aVar2.f3322p.get(0);
        } else {
            str = aVar2.f3323q.get(0);
        }
        return aVar.get(str);
    }
    ...
    private static Object u(z zVar, Object obj, Object obj2, Object obj3, Fragment fragment, boolean z10) {
        ...
        if (obj == null || obj2 == null || fragment == null) {
            ...
            z11 = z10 ? fragment.getAllowReturnTransitionOverlap() : fragment.getAllowEnterTransitionOverlap();
        }
        if (z11) {
    ...
    private static void v(z zVar, Object obj, Fragment fragment, ArrayList<View> arrayList) {
        if (fragment != null && obj != null && fragment.mAdded && fragment.mHidden && fragment.mHiddenChanged) {
            ...
            v.a(fragment.mContainer, new b(arrayList));
        }
    }

    private static z w() {
        try {
            return i1.e.class.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    private static void z(z zVar, Object obj, Object obj2, androidx.collection.a<String, View> aVar, boolean z10, a aVar2) {
        String str;
        ArrayList<String> arrayList = aVar2.f3322p;
