...
public class b {
    ...
    public static final d.e f3861a = new d.e("androidx.media2.session.MediaLibraryService", (Bundle) null);

    /* renamed from: b  reason: collision with root package name */
    public static final Executor f3862b = new a();

    /* renamed from: c  reason: collision with root package name */
    private static final Map<String, String> f3863c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map<String, String> f3864d = new HashMap();
    ...
    public static List<MediaItem> b(ParcelImplListSlice parcelImplListSlice) {
        ...
        List<ParcelImpl> b10 = parcelImplListSlice.b();
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < b10.size(); i10++) {
            ParcelImpl parcelImpl = b10.get(i10);
            if (parcelImpl != null) {
