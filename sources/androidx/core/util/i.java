...
public final class i {
    ...
    private static char[] f2460b = new char[24];
    ...
    public static void d(long j10, PrintWriter printWriter, int i10) {
        synchronized (f2459a) {
            printWriter.print(new String(f2460b, 0, e(j10, i10)));
        }
    }
    ...
    private static int e(long j10, int i10) {
        ...
        boolean z10 = i16 != 0;
        int i22 = i21;
        int f10 = f(cArr, i11, 'd', i21, false, 0);
        int f11 = f(cArr, i12, 'h', f10, f10 != i22, z10 ? 2 : 0);
        int f12 = f(cArr, i14, 'm', f11, f11 != i22, z10 ? 2 : 0);
        int f13 = f(cArr, i13, 's', f12, f12 != i22, z10 ? 2 : 0);
        int f14 = f(cArr, i19, 'm', f13, true, (!z10 || f13 == i22) ? 0 : 3);
        cArr[f14] = 's';
        return f14 + 1;
    }
