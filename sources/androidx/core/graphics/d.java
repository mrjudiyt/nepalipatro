...
public class d {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f2323a != bVarArr2[i10].f2323a || bVarArr[i10].f2324b.length != bVarArr2[i10].f2324b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f2323a = bVarArr2[i10].f2323a;
            for (int i11 = 0; i11 < bVarArr2[i10].f2324b.length; i11++) {
                bVarArr[i10].f2324b[i11] = bVarArr2[i10].f2324b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        private static void c(Path path, float f10, float f11, float f12, float f13, float f14, float f15, float f16, boolean z10, boolean z11) {
            ...
            if (d31 != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                ...
                int i10 = (atan22 > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 1 : (atan22 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 0 : -1));
                if (z13 != (i10 >= 0)) {
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            char c10 = 'm';
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                a(path, fArr, c10, bVarArr[i10].f2323a, bVarArr[i10].f2324b);
                c10 = bVarArr[i10].f2323a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f10) {
            ...
            int i10 = 0;
            while (true) {
                float[] fArr = bVar.f2324b;
                if (i10 < fArr.length) {
                    this.f2324b[i10] = (fArr[i10] * (1.0f - f10)) + (bVar2.f2324b[i10] * f10);
                    i10++;
                } else {
                    return;
                }
        ...
        b(b bVar) {
            this.f2323a = bVar.f2323a;
            float[] fArr = bVar.f2324b;
            this.f2324b = d.c(fArr, 0, fArr.length);
        }
    }
}
