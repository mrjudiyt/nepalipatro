...
class k {
    ...
    private ConcurrentHashMap<Long, e.c> f2371a = new ConcurrentHashMap<>();
    ...
    private void a(Typeface typeface, e.c cVar) {
        long k10 = k(typeface);
        if (k10 != 0) {
            this.f2371a.put(Long.valueOf(k10), cVar);
        }
    }
    ...
    private static <T> T g(T[] tArr, int i10, c<T> cVar) {
        return h(tArr, (i10 & 1) == 0 ? 400 : 700, (i10 & 2) != 0, cVar);
    }
    ...
    public e.c j(Typeface typeface) {
        ...
        return this.f2371a.get(Long.valueOf(k10));
    }
}
