...
public final class c {
    ...
    private static final ThreadLocal<TypedValue> f2272a = new ThreadLocal<>();
    ...
    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f2272a;
    ...
    private static int g(int i10, float f10, float f11) {
        ...
        int a10 = a.a((int) ((((float) Color.alpha(i10)) * f10) + 0.5f), 0, 255);
        if (z10) {
            a c10 = a.c(i10);
