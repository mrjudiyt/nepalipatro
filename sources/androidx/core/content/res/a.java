...
public class a {
    ...
    private final float f2266h;

    /* renamed from: i  reason: collision with root package name */
    private final float f2267i;
    ...
    static void d(int i10, l lVar, float[] fArr, float[] fArr2) {
        float[] fArr3 = fArr2;
        b.f(i10, fArr3);
        float[][] fArr4 = b.f2268a;
        float f10 = (fArr3[0] * fArr4[0][0]) + (fArr3[1] * fArr4[0][1]) + (fArr3[2] * fArr4[0][2]);
        float f11 = (fArr3[0] * fArr4[1][0]) + (fArr3[1] * fArr4[1][1]) + (fArr3[2] * fArr4[1][2]);
        float f12 = lVar.i()[0] * f10;
        float f13 = lVar.i()[1] * f11;
        float f14 = lVar.i()[2] * ((fArr3[0] * fArr4[2][0]) + (fArr3[1] * fArr4[2][1]) + (fArr3[2] * fArr4[2][2]));
        float pow = (float) Math.pow(((double) (lVar.c() * Math.abs(f12))) / 100.0d, 0.42d);
        float pow2 = (float) Math.pow(((double) (lVar.c() * Math.abs(f13))) / 100.0d, 0.42d);
        float pow3 = (float) Math.pow(((double) (lVar.c() * Math.abs(f14))) / 100.0d, 0.42d);
        ...
        float f15 = ((float) (((((double) signum) * 11.0d) + (((double) signum2) * -12.0d)) + d10)) / 11.0f;
        float f16 = ((float) (((double) (signum + signum2)) - (d10 * 2.0d))) / 9.0f;
        ...
        float pow4 = ((float) Math.pow((double) ((f19 * lVar.f()) / lVar.a()), (double) (lVar.b() * lVar.j()))) * 100.0f;
        float b10 = (4.0f / lVar.b()) * ((float) Math.sqrt((double) (pow4 / 100.0f))) * (lVar.a() + 4.0f) * lVar.d();
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, (double) lVar.e()), 0.73d)) * ((float) Math.pow((double) ((((((((float) (Math.cos(((((double) (((double) atan2) < 20.14d ? 360.0f + atan2 : atan2)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * lVar.g()) * lVar.h()) * ((float) Math.sqrt((double) ((f15 * f15) + (f16 * f16))))) / (f18 + 0.305f)), 0.9d));
    ...
    public static int m(float f10, float f11, float f12) {
        return n(f10, f11, f12, l.f2304k);
    }

    static int n(float f10, float f11, float f12, l lVar) {
        float f13;
        if (((double) f11) < 1.0d || ((double) Math.round(f12)) <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || ((double) Math.round(f12)) >= 100.0d) {
            return b.a(f12);
        }
        if (f10 < 0.0f) {
            f13 = 0.0f;
    ...
    /* access modifiers changed from: package-private */
    public int o(l lVar) {
        float pow = (float) Math.pow(((double) ((((double) i()) == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || ((double) k()) == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) ? 0.0f : i() / ((float) Math.sqrt(((double) k()) / 100.0d)))) / Math.pow(1.64d - Math.pow(0.29d, (double) lVar.e()), 0.73d), 1.1111111111111112d);
        ...
        float signum = Math.signum(f15) * (100.0f / lVar.c()) * ((float) Math.pow((double) ((float) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (((double) Math.abs(f15)) * 27.13d) / (400.0d - ((double) Math.abs(f15))))), 2.380952380952381d));
        float signum2 = Math.signum(f16) * (100.0f / lVar.c()) * ((float) Math.pow((double) ((float) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (((double) Math.abs(f16)) * 27.13d) / (400.0d - ((double) Math.abs(f16))))), 2.380952380952381d));
        float signum3 = Math.signum(f17) * (100.0f / lVar.c()) * ((float) Math.pow((double) ((float) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (((double) Math.abs(f17)) * 27.13d) / (400.0d - ((double) Math.abs(f17))))), 2.380952380952381d));
