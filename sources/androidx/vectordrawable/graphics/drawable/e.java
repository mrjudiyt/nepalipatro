...
public class e {
    ...
    private static class a implements TypeEvaluator<d.b[]> {
        ...
        public d.b[] evaluate(float f10, d.b[] bVarArr, d.b[] bVarArr2) {
            if (d.b(bVarArr, bVarArr2)) {
                if (!d.b(this.f4492a, bVarArr)) {
                    this.f4492a = d.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f4492a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f4492a;
            }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f4474h
            r7 = r22
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray s10 = k.s(resources, theme, attributeSet, a.f4476j);
        int i10 = 0;
        TypedValue t10 = k.t(s10, xmlPullParser, "value", 0);
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) {
        TypedArray s10 = k.s(resources, theme, attributeSet, a.f4473g);
        TypedArray s11 = k.s(resources, theme, attributeSet, a.f4477k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, s10, s11, f10, xmlPullParser);
        int l10 = k.l(s10, xmlPullParser, "interpolator", 0, 0);
        if (l10 > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) {
        Keyframe keyframe;
        TypedArray s10 = k.s(resources, theme, attributeSet, a.f4476j);
        float j10 = k.j(s10, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue t10 = k.t(s10, xmlPullParser, "value", 0);
        ...
        if (z10) {
            if (i10 == 0) {
                keyframe = Keyframe.ofFloat(j10, k.j(s10, xmlPullParser, "value", 0, 0.0f));
            } else if (i10 == 1 || i10 == 3) {
                keyframe = Keyframe.ofInt(j10, k.k(s10, xmlPullParser, "value", 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i10 == 0) {
        ...
        int l10 = k.l(s10, xmlPullParser, "interpolator", 1, 0);
        if (l10 > 0) {
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f4475i
            r11 = r18
            r12 = r19
            r13 = r21
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        long k10 = (long) k.k(typedArray, xmlPullParser, "duration", 1, 300);
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        String m10 = k.m(typedArray, xmlPullParser, "pathData", 1);
        if (m10 != null) {
            String m11 = k.m(typedArray, xmlPullParser, "propertyXName", 2);
            String m12 = k.m(typedArray, xmlPullParser, "propertyYName", 3);
            if (i10 != 2) {
            }
