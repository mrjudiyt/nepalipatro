...
public class h {
    ...
    private static final String f10317a = m.f("WrkDbPathHelper");

    /* renamed from: b  reason: collision with root package name */
    private static final String[] f10318b = {"-journal", "-shm", "-wal"};
    ...
    public static void e(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && b10.exists()) {
            m.c().a(f10317a, "Migrating WorkDatabase to the no-backup directory", new Throwable[0]);
            Map<File, File> f10 = f(context);
            for (File next : f10.keySet()) {
                File file = f10.get(next);
                if (next.exists() && file != null) {
                    if (file.exists()) {
                        m.c().h(f10317a, String.format("Over-writing contents of %s", new Object[]{file}), new Throwable[0]);
                    }
                    ...
                    m.c().a(f10317a, str, new Throwable[0]);
                }
            }
        }
    }
