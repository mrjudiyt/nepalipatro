...
public final class a {
    ...
    private static final Object f10654f = new Object();

    /* renamed from: g  reason: collision with root package name */
    private static a f10655g;

    /* renamed from: a  reason: collision with root package name */
    private final Context f10656a;

    /* renamed from: b  reason: collision with root package name */
    private final HashMap<BroadcastReceiver, ArrayList<c>> f10657b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private final HashMap<String, ArrayList<c>> f10658c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private final ArrayList<b> f10659d = new ArrayList<>();

    /* renamed from: e  reason: collision with root package name */
    private final Handler f10660e;

    /* renamed from: q0.a$a  reason: collision with other inner class name */
    /* compiled from: LocalBroadcastManager */
    class C0184a extends Handler {
        C0184a(Looper looper) {
            super(looper);
        }
    ...
    private static final class c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f10664a;

        /* renamed from: b  reason: collision with root package name */
        final BroadcastReceiver f10665b;
        ...
        c(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f10664a = intentFilter;
            this.f10665b = broadcastReceiver;
        }
    ...
    private a(Context context) {
        ...
        this.f10660e = new C0184a(context.getMainLooper());
    }

    public static a b(Context context) {
        a aVar;
        synchronized (f10654f) {
            if (f10655g == null) {
                f10655g = new a(context.getApplicationContext());
            }
            aVar = f10655g;
        }
        return aVar;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0029, code lost:
        r7 = r4.f10663b.get(r6);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0033, code lost:
        if (r7.f10667d != false) goto L_0x003e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0035, code lost:
        r7.f10665b.onReceive(r10.f10656a, r4.f10662a);
     */
    ...
    public void a() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<q0.a$c>> r0 = r10.f10657b
            monitor-enter(r0)
            java.util.ArrayList<q0.a$b> r1 = r10.f10659d     // Catch:{ all -> 0x0044 }
            int r1 = r1.size()     // Catch:{ all -> 0x0044 }
            if (r1 > 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0044 }
            return
        L_0x000d:
            q0.a$b[] r2 = new q0.a.b[r1]     // Catch:{ all -> 0x0044 }
            java.util.ArrayList<q0.a$b> r3 = r10.f10659d     // Catch:{ all -> 0x0044 }
        ...
        L_0x001c:
            if (r3 >= r1) goto L_0x0000
            r4 = r2[r3]
            java.util.ArrayList<q0.a$c> r5 = r4.f10663b
            int r5 = r5.size()
            r6 = 0
        L_0x0027:
            if (r6 >= r5) goto L_0x0041
            java.util.ArrayList<q0.a$c> r7 = r4.f10663b
            java.lang.Object r7 = r7.get(r6)
            q0.a$c r7 = (q0.a.c) r7
            boolean r8 = r7.f10667d
            if (r8 != 0) goto L_0x003e
            android.content.BroadcastReceiver r7 = r7.f10665b
            android.content.Context r8 = r10.f10656a
            android.content.Intent r9 = r4.f10662a
            r7.onReceive(r8, r9)
        L_0x003e:
            int r6 = r6 + 1
            goto L_0x0027
        ...
        L_0x0044:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: q0.a.a():void");
    }

    public void c(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f10657b) {
            c cVar = new c(intentFilter, broadcastReceiver);
            ArrayList arrayList = this.f10657b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f10657b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(cVar);
            for (int i10 = 0; i10 < intentFilter.countActions(); i10++) {
                String action = intentFilter.getAction(i10);
                ArrayList arrayList2 = this.f10658c.get(action);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList(1);
                    this.f10658c.put(action, arrayList2);
                }
                arrayList2.add(cVar);
            }
        }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean d(android.content.Intent r23) {
        /*
            r22 = this;
            r1 = r22
            r0 = r23
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<q0.a$c>> r2 = r1.f10657b
            monitor-enter(r2)
            java.lang.String r10 = r23.getAction()     // Catch:{ all -> 0x0143 }
            android.content.Context r3 = r1.f10656a     // Catch:{ all -> 0x0143 }
        ...
        L_0x004e:
            java.util.HashMap<java.lang.String, java.util.ArrayList<q0.a$c>> r3 = r1.f10658c     // Catch:{ all -> 0x0143 }
        ...
        L_0x006f:
            ...
            r5 = r3
            q0.a$c r5 = (q0.a.c) r5     // Catch:{ all -> 0x0143 }
            if (r16 == 0) goto L_0x008d
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x0143 }
            r3.<init>()     // Catch:{ all -> 0x0143 }
            java.lang.String r4 = "Matching against filter "
            r3.append(r4)     // Catch:{ all -> 0x0143 }
            android.content.IntentFilter r4 = r5.f10664a     // Catch:{ all -> 0x0143 }
            r3.append(r4)     // Catch:{ all -> 0x0143 }
        L_0x008d:
            boolean r3 = r5.f10666c     // Catch:{ all -> 0x0143 }
            ...
            goto L_0x0104
        L_0x009d:
            android.content.IntentFilter r3 = r5.f10664a     // Catch:{ all -> 0x0143 }
        ...
        L_0x00d5:
            ...
            r15.f10666c = r11     // Catch:{ all -> 0x0143 }
            goto L_0x0105
        L_0x00db:
        ...
        L_0x0115:
            ...
            q0.a$c r4 = (q0.a.c) r4     // Catch:{ all -> 0x0143 }
            r5 = 0
            r4.f10666c = r5     // Catch:{ all -> 0x0143 }
            int r3 = r3 + 1
            goto L_0x0115
        L_0x0127:
            java.util.ArrayList<q0.a$b> r3 = r1.f10659d     // Catch:{ all -> 0x0143 }
            q0.a$b r4 = new q0.a$b     // Catch:{ all -> 0x0143 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0143 }
            r3.add(r4)     // Catch:{ all -> 0x0143 }
            android.os.Handler r0 = r1.f10660e     // Catch:{ all -> 0x0143 }
        ...
        L_0x0143:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: q0.a.d(android.content.Intent):boolean");
    }

    public void e(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f10657b) {
            ArrayList remove = this.f10657b.remove(broadcastReceiver);
            if (remove != null) {
                for (int size = remove.size() - 1; size >= 0; size--) {
                    c cVar = (c) remove.get(size);
                    cVar.f10667d = true;
                    for (int i10 = 0; i10 < cVar.f10664a.countActions(); i10++) {
                        String action = cVar.f10664a.getAction(i10);
                        ArrayList arrayList = this.f10658c.get(action);
                        if (arrayList != null) {
                            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                                c cVar2 = (c) arrayList.get(size2);
                                if (cVar2.f10665b == broadcastReceiver) {
                                    cVar2.f10667d = true;
                                    arrayList.remove(size2);
                                }
                            }
                            if (arrayList.size() <= 0) {
                                this.f10658c.remove(action);
                            }
                        }
                    }
                }
