...
public final class c {
    ...
    private static final int[] f8840a = {AdError.CACHE_ERROR_CODE, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, 480, 400, 400, 2048};
    ...
    public static void a(int i10, y yVar) {
        yVar.K(7);
        byte[] d10 = yVar.d();
        d10[0] = -84;
        d10[1] = 64;
    ...
    public static j b(y yVar, String str, String str2, h hVar) {
        yVar.P(1);
        return new j.b().S(str).e0("audio/ac4").H(2).f0(((yVar.C() & 32) >> 5) == 1 ? 48000 : 44100).L(hVar).V(str2).E();
    }
    ...
    public static g4.c.b d(a6.x r10) {
        /*
            r0 = 16
            int r1 = r10.h(r0)
            int r0 = r10.h(r0)
        ...
        L_0x0099:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: g4.c.d(a6.x):g4.c$b");
    }
    ...
    private static int f(x xVar, int i10) {
        int i11 = 0;
        while (true) {
            int h10 = i11 + xVar.h(i10);
            if (!xVar.g()) {
                return h10;
            }
            i11 = (h10 + 1) << i10;
