...
class e {
    ...
    private static final a f8817f = new a();

    /* renamed from: a  reason: collision with root package name */
    private final a f8818a;

    /* renamed from: b  reason: collision with root package name */
    private final d f8819b;

    /* renamed from: c  reason: collision with root package name */
    private final b f8820c;

    /* renamed from: d  reason: collision with root package name */
    private final ContentResolver f8821d;

    /* renamed from: e  reason: collision with root package name */
    private final List<ImageHeaderParser> f8822e;

    e(List<ImageHeaderParser> list, d dVar, b bVar, ContentResolver contentResolver) {
        this(list, f8817f, dVar, bVar, contentResolver);
    }
    ...
    private java.lang.String b(android.net.Uri r5) {
        /*
            r4 = this;
            r0 = 0
            g2.d r1 = r4.f8819b     // Catch:{ SecurityException -> 0x0020, all -> 0x001e }
    ...
    private boolean c(File file) {
        return this.f8818a.a(file) && 0 < this.f8818a.c(file);
    }
    ...
    public int a(Uri uri) {
        ...
        try {
            InputStream openInputStream = this.f8821d.openInputStream(uri);
            int b10 = a.b(this.f8822e, openInputStream, this.f8820c);
    ...
    public InputStream d(Uri uri) {
        ...
        File b11 = this.f8818a.b(b10);
        if (!c(b11)) {
            return null;
        }
        Uri fromFile = Uri.fromFile(b11);
        try {
            return this.f8821d.openInputStream(fromFile);
