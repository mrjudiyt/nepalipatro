...
public final class k {
    ...
    private static final Map<Class<?>, Class<?>> f16548a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f16549b;
    ...
    static {
        ...
        f16548a = Collections.unmodifiableMap(hashMap);
        f16549b = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public static boolean b(Type type) {
        return f16548a.containsKey(type);
    }

    public static <T> Class<T> c(Class<T> cls) {
        Class<T> cls2 = f16548a.get(a.b(cls));
