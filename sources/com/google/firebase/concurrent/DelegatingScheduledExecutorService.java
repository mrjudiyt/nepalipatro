...
class DelegatingScheduledExecutorService implements ScheduledExecutorService {
    ...
    public /* synthetic */ ScheduledFuture lambda$schedule$2(Runnable runnable, long j10, TimeUnit timeUnit, DelegatingScheduledFuture.Completer completer) {
        return this.scheduler.schedule(new h(this, runnable, completer), j10, timeUnit);
    }
    ...
    public /* synthetic */ ScheduledFuture lambda$scheduleAtFixedRate$8(Runnable runnable, long j10, long j11, TimeUnit timeUnit, DelegatingScheduledFuture.Completer completer) {
        return this.scheduler.scheduleAtFixedRate(new i(this, runnable, completer), j10, j11, timeUnit);
    }
    ...
    public ScheduledFuture<?> schedule(Runnable runnable, long j10, TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new f(this, runnable, j10, timeUnit));
    }

    public ScheduledFuture<?> scheduleAtFixedRate(Runnable runnable, long j10, long j11, TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new b(this, runnable, j10, j11, timeUnit));
    }

    public ScheduledFuture<?> scheduleWithFixedDelay(Runnable runnable, long j10, long j11, TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new e(this, runnable, j10, j11, timeUnit));
    }
    ...
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long j10, TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new g(this, callable, j10, timeUnit));
    }
