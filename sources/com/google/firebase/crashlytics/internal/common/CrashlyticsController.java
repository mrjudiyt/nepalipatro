...
class CrashlyticsController {
    static final FilenameFilter APP_EXCEPTION_MARKER_FILTER = c.f13880a;
        ...
        try {
            Utils.awaitEvenIfOnMainThread(this.backgroundWorker.submitTask(new Callable<Task<Void>>() {
                public Task<Void> call() {
                    ...
                    CrashlyticsController.this.doOpenSession(new CLSUUID(CrashlyticsController.this.idManager).toString(), Boolean.valueOf(z11));
