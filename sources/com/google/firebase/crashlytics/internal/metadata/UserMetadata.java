...
public class UserMetadata {
    ...
    private class SerializeableKeysMap {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            c cVar = new c(this);
            if (this.queuedSerializer.compareAndSet((Object) null, cVar)) {
                UserMetadata.this.backgroundWorker.submit(cVar);
            }
        }
    ...
    public boolean updateRolloutsState(List<RolloutAssignment> list) {
        synchronized (this.rolloutsState) {
            ...
            this.backgroundWorker.submit(new b(this, this.rolloutsState.getRolloutAssignmentList()));
            return true;
        }
    }
}
