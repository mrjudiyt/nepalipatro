...
final class AutoValue_CrashlyticsReport_Session_Event_Device extends CrashlyticsReport.Session.Event.Device {
    ...
    public int hashCode() {
        Double d10 = this.batteryLevel;
        int hashCode = ((((d10 == null ? 0 : d10.hashCode()) ^ 1000003) * 1000003) ^ this.batteryVelocity) * 1000003;
        int i10 = this.proximityOn ? 1231 : 1237;
        long j10 = this.ramUsed;
        long j11 = this.diskUsed;
        return ((((((hashCode ^ i10) * 1000003) ^ this.orientation) * 1000003) ^ ((int) (j10 ^ (j10 >>> 32)))) * 1000003) ^ ((int) (j11 ^ (j11 >>> 32)));
    }
