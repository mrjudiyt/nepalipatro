...
final class ReportQueue {
    ...
    ReportQueue(f<CrashlyticsReport> fVar, Settings settings, OnDemandCounter onDemandCounter2) {
        this(settings.onDemandUploadRatePerMinute, settings.onDemandBackoffBase, ((long) settings.onDemandBackoffStepDurationSeconds) * 1000, fVar, onDemandCounter2);
    }
    ...
    public void sendReport(CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        this.transport.b(c.e(crashlyticsReportWithSessionId.getReport()), new c(this, taskCompletionSource, SystemClock.elapsedRealtime() - this.startTimeMs < 2000, crashlyticsReportWithSessionId));
    }
    ...
    ReportQueue(double d10, double d11, long j10, f<CrashlyticsReport> fVar, OnDemandCounter onDemandCounter2) {
