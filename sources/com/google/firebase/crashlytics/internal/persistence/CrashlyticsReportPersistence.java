...
public class CrashlyticsReportPersistence {
    ...
    private static final FilenameFilter EVENT_FILE_FILTER = b.f13905a;
    private static final String EVENT_FILE_NAME_PREFIX = "event";
    private static final int EVENT_NAME_LENGTH = 15;
    private static final Comparator<? super File> LATEST_SESSION_ID_FIRST_COMPARATOR = c.f13906h;
    ...
    private static String generateEventFilename(int i10, boolean z10) {
        ...
        String str = z10 ? PRIORITY_EVENT_SUFFIX : "";
    ...
    private void synthesizeReport(String str, long j10) {
        ...
        String appQualitySessionId = this.sessionsSubscriber.getAppQualitySessionId(str);
        synthesizeReportFile(this.fileStore.getSessionFile(str, REPORT_FILE_NAME), arrayList, j10, z10, readUserId, appQualitySessionId);
    }
    ...
    private int trimEvents(String str, int i10) {
        List<File> sessionFiles = this.fileStore.getSessionFiles(str, a.f13904a);
        Collections.sort(sessionFiles, d.f13907h);
