...
public final class CommonNotificationBuilder {
    ...
    public static class DisplayNotificationInfo {
        public final int id;
        public final l.e notificationBuilder;
        public final String tag;

        DisplayNotificationInfo(l.e eVar, String str, int i10) {
    ...
    public static DisplayNotificationInfo createNotificationInfo(Context context, Context context2, NotificationParams notificationParams, String str, Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(possiblyLocalizedString)) {
            eVar.r(possiblyLocalizedString);
        }
        ...
        if (!TextUtils.isEmpty(possiblyLocalizedString2)) {
            eVar.q(possiblyLocalizedString2);
            eVar.L(new l.c().r(possiblyLocalizedString2));
        }
        eVar.J(getSmallIcon(packageManager, resources, packageName, notificationParams.getString(Constants.MessageNotificationKeys.ICON), bundle));
        Uri sound = getSound(packageName, notificationParams, resources);
        if (sound != null) {
            eVar.K(sound);
        }
        eVar.p(createContentIntent(context, notificationParams, packageName, packageManager));
        PendingIntent createDeleteIntent = createDeleteIntent(context, context2, notificationParams);
        if (createDeleteIntent != null) {
            eVar.v(createDeleteIntent);
        }
        Integer color = getColor(context2, notificationParams.getString(Constants.MessageNotificationKeys.COLOR), bundle);
        if (color != null) {
            eVar.n(color.intValue());
        }
        eVar.l(!notificationParams.getBoolean(Constants.MessageNotificationKeys.STICKY));
        eVar.D(notificationParams.getBoolean(Constants.MessageNotificationKeys.LOCAL_ONLY));
        ...
        if (notificationPriority != null) {
            eVar.H(notificationPriority.intValue());
        }
        ...
        if (notificationCount != null) {
            eVar.E(notificationCount.intValue());
        }
        ...
        if (lightSettings != null) {
            eVar.C(lightSettings[0], lightSettings[1], lightSettings[2]);
        }
        eVar.u(getConsolidatedDefaults(notificationParams));
