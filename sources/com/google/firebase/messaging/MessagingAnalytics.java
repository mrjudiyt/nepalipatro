...
public class MessagingAnalytics {
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, g gVar) {
        ...
        if (gVar != null && (eventToProto = eventToProto(event, intent)) != null) {
            try {
                gVar.a(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, b.b("proto"), x.f13984a).a(c.d(MessagingClientEventExtension.newBuilder().setMessagingClientEvent(eventToProto).build()));
    ...
    private static void setUserPropertyIfRequired(Bundle bundle) {
        ...
        if (bundle != null && AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(bundle.getString(Constants.AnalyticsKeys.TRACK_CONVERSIONS)) && (analyticsConnector = (AnalyticsConnector) FirebaseApp.getInstance().get(AnalyticsConnector.class)) != null) {
