...
public class ConfigCacheClient {
    private static final Executor DIRECT_EXECUTOR = i.f3908h;
    ...
    private static <TResult> TResult await(Task<TResult> task, long j10, TimeUnit timeUnit) {
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ Task lambda$put$1(boolean z10, ConfigContainer configContainer, Void voidR) {
        if (z10) {
    ...
    public synchronized Task<ConfigContainer> get() {
        ...
        if (task == null || (task.isComplete() && !this.cachedContainerTask.isSuccessful())) {
            ...
            this.cachedContainerTask = Tasks.call(executor2, new d(configStorageClient));
        }
    ...
    public Task<ConfigContainer> put(ConfigContainer configContainer, boolean z10) {
        return Tasks.call(this.executor, new c(this, configContainer)).onSuccessTask(this.executor, new b(this, z10, configContainer));
    }
}
