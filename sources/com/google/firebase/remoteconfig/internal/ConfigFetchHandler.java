...
public class ConfigFetchHandler {
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date, Map<String, String> map) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new i(fetchFromBackend));
    ...
    public Task<FetchResponse> lambda$fetch$0(Task<ConfigContainer> task, long j10, Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new f(this, id, token, date, map));
        }
        return task2.continueWithTask(this.executor, new g(this, date));
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i10) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new h(this, hashMap));
    }
    ...
    public Task<FetchResponse> fetch(long j10) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new e(this, j10, hashMap));
    }
}
