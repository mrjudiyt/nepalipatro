...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    KeyHandle(@SafeParcelable.Param(id = 1) int i10, @SafeParcelable.Param(id = 2) byte[] bArr, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) List list) {
        this.zza = i10;
        this.zzb = bArr;
        try {
