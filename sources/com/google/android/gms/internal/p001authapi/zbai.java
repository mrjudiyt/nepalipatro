...
public final class zbai extends zba {
    ...
    public final void zbc(zby zby, BeginSignInRequest beginSignInRequest) {
        Parcel zba = zba();
        zbc.zbd(zba, zby);
    ...
    public final void zbd(zbab zbab, GetPhoneNumberHintIntentRequest getPhoneNumberHintIntentRequest, String str) {
        Parcel zba = zba();
        zbc.zbd(zba, zbab);
    ...
    public final void zbe(zbad zbad, GetSignInIntentRequest getSignInIntentRequest) {
        Parcel zba = zba();
        zbc.zbd(zba, zbad);
