...
final class zzdt {
    static int zza(byte[] bArr, int i10, zzds zzds) {
    ...
    static int zzc(zzgh zzgh, byte[] bArr, int i10, int i11, int i12, zzds zzds) {
        zzfz zzfz = (zzfz) zzgh;
        Object zzd = zzfz.zzd();
    ...
    static int zzd(com.google.android.gms.internal.auth.zzgh r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.auth.zzds r10) {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
    ...
    static int zze(zzgh zzgh, int i10, byte[] bArr, int i11, int i12, zzey zzey, zzds zzds) {
    ...
    static int zzf(byte[] bArr, int i10, zzey zzey, zzds zzds) {
        zzev zzev = (zzev) zzey;
        int zzj = zzj(bArr, i10, zzds);
    ...
    static int zzg(byte[] bArr, int i10, zzds zzds) {
        int zzj = zzj(bArr, i10, zzds);
        int i11 = zzds.zza;
        if (i11 < 0) {
            throw zzfa.zzc();
    ...
    static int zzh(byte[] bArr, int i10, zzds zzds) {
        int zzj = zzj(bArr, i10, zzds);
        int i11 = zzds.zza;
        if (i11 < 0) {
            throw zzfa.zzc();
    ...
    static int zzi(int i10, byte[] bArr, int i11, int i12, zzgz zzgz, zzds zzds) {
        if ((i10 >>> 3) != 0) {
            int i13 = i10 & 7;
            if (i13 == 0) {
