...
final class zztp {
    ...
    public final void zzA(int i10, List<Long> list, boolean z10) {
        int i11 = 0;
        if (z10) {
            this.zza.zzo(i10, 2);
            int i12 = 0;
    ...
    public final void zzH(int i10, List<String> list) {
        int i11 = 0;
    ...
    public final void zzd(int i10, zztd zztd) {
        this.zza.zze(i10, zztd);
    }

    public final void zze(int i10, List<zztd> list) {
    ...
    public final void zzq(int i10, Object obj, zzwx zzwx) {
        zzto zzto = this.zza;
        zzto.zzo(i10, 3);
    ...
    public final void zzv(int i10, Object obj, zzwx zzwx) {
        zzwk zzwk = (zzwk) obj;
    ...
    public final void zzy(int i10, List<Integer> list, boolean z10) {
        int i11 = 0;
        if (z10) {
            this.zza.zzo(i10, 2);
            int i12 = 0;
