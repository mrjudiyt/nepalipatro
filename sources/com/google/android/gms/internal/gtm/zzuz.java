...
public abstract class zzuz<MessageType extends zzuz<MessageType, BuilderType>, BuilderType extends zzut<MessageType, BuilderType>> extends zzsh<MessageType, BuilderType> {
    ...
    protected static <T extends zzuz<T, ?>> T zzac(T t10, InputStream inputStream, zzuj zzuj) {
    ...
    protected static <T extends zzuz<T, ?>> T zzad(T t10, byte[] bArr, zzuj zzuj) {
        T zzae = zzae(t10, bArr, 0, bArr.length, zzuj);
        zzc(zzae);
        return zzae;
    }

    static <T extends zzuz<T, ?>> T zzae(T t10, byte[] bArr, int i10, int i11, zzuj zzuj) {
        T t11 = (zzuz) t10.zzb(4, (Object) null, (Object) null);
        try {
            zzwx<?> zzb = zzwt.zza().zzb(t11.getClass());
    ...
    private static <T extends zzuz<T, ?>> T zzc(T t10) {
