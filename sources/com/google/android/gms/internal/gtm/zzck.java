...
final class zzck extends zzbs {
    ...
    public final long zzb(zzbx zzbx, boolean z10) {
        ...
        try {
            ...
            zzce.zzW();
            zzr.zzh();
            int delete = zzce.zzf().delete("properties", "app_uid=? AND cid<>?", new String[]{AppEventsConstants.EVENT_PARAM_VALUE_NO, zzb2});
            if (delete > 0) {
    ...
    public final void zzg(zzcz zzcz, long j10) {
        ...
        zzW();
        long zzb2 = zzA().zzb();
        zzG("Dispatching local hits. Elapsed time since last dispatch (ms)", Long.valueOf(zzb2 != 0 ? Math.abs(zzC().currentTimeMillis() - zzb2) : -1));
        zzw();
        zzi();
        try {
            zzaf();
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:61:0x0198 A[Catch:{ SQLiteException -> 0x0204 }] */
    ...
    public final void zzj(com.google.android.gms.internal.gtm.zzex r22) {
        ...
        L_0x0089:
            r21.zzw()
            com.google.android.gms.internal.gtm.zzce r5 = r1.zzb     // Catch:{ SQLiteException -> 0x0204 }
            com.google.android.gms.common.internal.Preconditions.checkNotNull(r3)     // Catch:{ SQLiteException -> 0x0204 }
            com.google.android.gms.analytics.zzr.zzh()     // Catch:{ SQLiteException -> 0x0204 }
            r5.zzW()     // Catch:{ SQLiteException -> 0x0204 }
            com.google.android.gms.common.internal.Preconditions.checkNotNull(r3)     // Catch:{ SQLiteException -> 0x0204 }
            android.net.Uri$Builder r0 = new android.net.Uri$Builder     // Catch:{ SQLiteException -> 0x0204 }
            r0.<init>()     // Catch:{ SQLiteException -> 0x0204 }
            java.util.Map r6 = r3.zzg()     // Catch:{ SQLiteException -> 0x0204 }
            java.util.Set r6 = r6.entrySet()     // Catch:{ SQLiteException -> 0x0204 }
            java.util.Iterator r6 = r6.iterator()     // Catch:{ SQLiteException -> 0x0204 }
        L_0x00ab:
            boolean r7 = r6.hasNext()     // Catch:{ SQLiteException -> 0x0204 }
            if (r7 == 0) goto L_0x00df
            java.lang.Object r7 = r6.next()     // Catch:{ SQLiteException -> 0x0204 }
            java.util.Map$Entry r7 = (java.util.Map.Entry) r7     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.Object r8 = r7.getKey()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r8 = (java.lang.String) r8     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r9 = "ht"
            boolean r9 = r9.equals(r8)     // Catch:{ SQLiteException -> 0x0204 }
            ...
            boolean r9 = r9.equals(r8)     // Catch:{ SQLiteException -> 0x0204 }
            if (r9 != 0) goto L_0x00ab
            java.lang.Object r7 = r7.getValue()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r7 = (java.lang.String) r7     // Catch:{ SQLiteException -> 0x0204 }
            r0.appendQueryParameter(r8, r7)     // Catch:{ SQLiteException -> 0x0204 }
            goto L_0x00ab
        L_0x00df:
            android.net.Uri r0 = r0.build()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r0 = r0.getEncodedQuery()     // Catch:{ SQLiteException -> 0x0204 }
            if (r0 != 0) goto L_0x00eb
            java.lang.String r0 = ""
        L_0x00eb:
            r6 = r0
            int r0 = r6.length()     // Catch:{ SQLiteException -> 0x0204 }
            r7 = 8192(0x2000, float:1.14794E-41)
            if (r0 <= r7) goto L_0x00ff
            com.google.android.gms.internal.gtm.zzfb r0 = r5.zzz()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r2 = "Hit length exceeds the maximum allowed size"
            r0.zzb(r3, r2)     // Catch:{ SQLiteException -> 0x0204 }
            goto L_0x0200
        L_0x00ff:
            r5.zzw()     // Catch:{ SQLiteException -> 0x0204 }
            com.google.android.gms.internal.gtm.zzet<java.lang.Integer> r0 = com.google.android.gms.internal.gtm.zzeu.zzf     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.Object r0 = r0.zzb()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.Integer r0 = (java.lang.Integer) r0     // Catch:{ SQLiteException -> 0x0204 }
            int r0 = r0.intValue()     // Catch:{ SQLiteException -> 0x0204 }
            long r7 = r5.zzb()     // Catch:{ SQLiteException -> 0x0204 }
            int r9 = r0 + -1
            long r9 = (long) r9     // Catch:{ SQLiteException -> 0x0204 }
            r11 = 0
            int r12 = (r7 > r9 ? 1 : (r7 == r9 ? 0 : -1))
            if (r12 <= 0) goto L_0x019c
            long r9 = (long) r0     // Catch:{ SQLiteException -> 0x0204 }
            long r7 = r7 - r9
            r9 = 1
            long r7 = r7 + r9
            com.google.android.gms.analytics.zzr.zzh()     // Catch:{ SQLiteException -> 0x0204 }
            ...
            java.util.List r0 = java.util.Collections.emptyList()     // Catch:{ SQLiteException -> 0x0204 }
            goto L_0x0183
        L_0x0130:
            android.database.sqlite.SQLiteDatabase r12 = r5.zzf()     // Catch:{ SQLiteException -> 0x0204 }
            java.util.ArrayList r9 = new java.util.ArrayList     // Catch:{ SQLiteException -> 0x0204 }
            r9.<init>()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String[] r14 = new java.lang.String[]{r2}     // Catch:{ SQLiteException -> 0x0178, all -> 0x0176 }
            java.lang.Object[] r0 = new java.lang.Object[r4]     // Catch:{ SQLiteException -> 0x0178, all -> 0x0176 }
            r4 = 0
            r0[r4] = r2     // Catch:{ SQLiteException -> 0x0178, all -> 0x0176 }
            ...
            java.lang.String r19 = java.lang.String.format(r2, r0)     // Catch:{ SQLiteException -> 0x0178, all -> 0x0176 }
            java.lang.String r20 = java.lang.Long.toString(r7)     // Catch:{ SQLiteException -> 0x0178, all -> 0x0176 }
            android.database.Cursor r2 = r12.query(r13, r14, r15, r16, r17, r18, r19, r20)     // Catch:{ SQLiteException -> 0x0178, all -> 0x0176 }
            boolean r0 = r2.moveToFirst()     // Catch:{ SQLiteException -> 0x0174 }
            if (r0 == 0) goto L_0x0170
        L_0x015f:
            long r7 = r2.getLong(r4)     // Catch:{ SQLiteException -> 0x0174 }
            java.lang.Long r0 = java.lang.Long.valueOf(r7)     // Catch:{ SQLiteException -> 0x0174 }
            r9.add(r0)     // Catch:{ SQLiteException -> 0x0174 }
            boolean r0 = r2.moveToNext()     // Catch:{ SQLiteException -> 0x0174 }
            if (r0 != 0) goto L_0x015f
        L_0x0170:
            r2.close()     // Catch:{ SQLiteException -> 0x0204 }
            goto L_0x0182
        L_0x0174:
            r0 = move-exception
            goto L_0x017a
        ...
        L_0x0183:
            ...
            int r4 = r0.size()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ SQLiteException -> 0x0204 }
            r5.zzS(r2, r4)     // Catch:{ SQLiteException -> 0x0204 }
            r5.zzZ(r0)     // Catch:{ SQLiteException -> 0x0204 }
            goto L_0x019c
        L_0x0194:
            r0 = move-exception
            r11 = r2
        L_0x0196:
            ...
            r11.close()     // Catch:{ SQLiteException -> 0x0204 }
        L_0x019b:
            throw r0     // Catch:{ SQLiteException -> 0x0204 }
        L_0x019c:
            android.database.sqlite.SQLiteDatabase r0 = r5.zzf()     // Catch:{ SQLiteException -> 0x0204 }
            android.content.ContentValues r2 = new android.content.ContentValues     // Catch:{ SQLiteException -> 0x0204 }
            r2.<init>()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r4 = "hit_string"
            r2.put(r4, r6)     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r4 = "hit_time"
            long r6 = r3.zzd()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.Long r6 = java.lang.Long.valueOf(r6)     // Catch:{ SQLiteException -> 0x0204 }
            r2.put(r4, r6)     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r4 = "hit_app_id"
            int r6 = r3.zza()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)     // Catch:{ SQLiteException -> 0x0204 }
            r2.put(r4, r6)     // Catch:{ SQLiteException -> 0x0204 }
            boolean r4 = r3.zzh()     // Catch:{ SQLiteException -> 0x0204 }
            if (r4 == 0) goto L_0x01d2
            r5.zzw()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r4 = com.google.android.gms.internal.gtm.zzct.zzi()     // Catch:{ SQLiteException -> 0x0204 }
            goto L_0x01d9
        L_0x01d2:
            r5.zzw()     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r4 = com.google.android.gms.internal.gtm.zzct.zzk()     // Catch:{ SQLiteException -> 0x0204 }
        L_0x01d9:
            java.lang.String r6 = "hit_url"
            r2.put(r6, r4)     // Catch:{ SQLiteException -> 0x0204 }
            java.lang.String r4 = "hits2"
            long r6 = r0.insert(r4, r11, r2)     // Catch:{ SQLiteException -> 0x01fa }
            r8 = -1
            int r0 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
            if (r0 != 0) goto L_0x01f0
            java.lang.String r0 = "Failed to insert a hit (got -1)"
            r5.zzJ(r0)     // Catch:{ SQLiteException -> 0x01fa }
            goto L_0x0200
        L_0x01f0:
            java.lang.String r0 = "Hit saved to database. db-id, hit"
            java.lang.Long r2 = java.lang.Long.valueOf(r6)     // Catch:{ SQLiteException -> 0x01fa }
            r5.zzH(r0, r2, r3)     // Catch:{ SQLiteException -> 0x01fa }
            goto L_0x0200
        L_0x01fa:
            r0 = move-exception
            java.lang.String r2 = "Error storing a hit"
            r5.zzK(r2, r0)     // Catch:{ SQLiteException -> 0x0204 }
        L_0x0200:
            r21.zzae()     // Catch:{ SQLiteException -> 0x0204 }
            return
        L_0x0204:
            r0 = move-exception
    ...
    public final void zzn(String str) {
        ...
        if (str2.equals(zzg2)) {
            ...
            try {
                ...
                Cursor query = zzf3.query("properties", strArr, "app_uid=?", new String[]{AppEventsConstants.EVENT_PARAM_VALUE_NO}, (String) null, (String) null, (String) null, String.valueOf(intValue));
