...
final class zzwz {
    ...
    static <UT, UB> UB zzC(int i10, List<Integer> list, zzvd zzvd, UB ub, zzxo<UT, UB> zzxo) {
        if (zzvd == null) {
            return ub;
        }
    ...
    static <UT, UB> UB zzD(int i10, int i11, UB ub, zzxo<UT, UB> zzxo) {
        if (ub == null) {
            ub = zzxo.zzf();
        }
        zzxo.zzl(ub, i10, (long) i11);
        return ub;
    }
    ...
    public static void zzJ(int i10, List<Boolean> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzc(i10, list, z10);
        }
    }

    public static void zzK(int i10, List<zztd> list, zztp zztp) {
        if (list != null && !list.isEmpty()) {
            zztp.zze(i10, list);
        }
    }

    public static void zzL(int i10, List<Double> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzg(i10, list, z10);
        }
    }

    public static void zzM(int i10, List<Integer> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzj(i10, list, z10);
        }
    }

    public static void zzN(int i10, List<Integer> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzl(i10, list, z10);
        }
    }

    public static void zzO(int i10, List<Long> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzn(i10, list, z10);
        }
    }

    public static void zzP(int i10, List<Float> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzp(i10, list, z10);
        }
    }

    public static void zzQ(int i10, List<?> list, zztp zztp, zzwx zzwx) {
        if (list != null && !list.isEmpty()) {
    ...
    public static void zzR(int i10, List<Integer> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzs(i10, list, z10);
        }
    }

    public static void zzS(int i10, List<Long> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzu(i10, list, z10);
        }
    }

    public static void zzT(int i10, List<?> list, zztp zztp, zzwx zzwx) {
        if (list != null && !list.isEmpty()) {
            for (int i11 = 0; i11 < list.size(); i11++) {
    ...
    public static void zzU(int i10, List<Integer> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzy(i10, list, z10);
        }
    }

    public static void zzV(int i10, List<Long> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzA(i10, list, z10);
        }
    }

    public static void zzW(int i10, List<Integer> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzC(i10, list, z10);
        }
    }

    public static void zzX(int i10, List<Long> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzE(i10, list, z10);
        }
    }

    public static void zzY(int i10, List<String> list, zztp zztp) {
        if (list != null && !list.isEmpty()) {
            zztp.zzH(i10, list);
        }
    }

    public static void zzZ(int i10, List<Integer> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzJ(i10, list, z10);
        }
    }
    ...
    public static void zzaa(int i10, List<Long> list, zztp zztp, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zztp.zzL(i10, list, z10);
        }
    }
