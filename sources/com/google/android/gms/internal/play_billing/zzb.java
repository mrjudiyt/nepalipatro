...
public final class zzb {
    ...
    public static f zzd(Intent intent, String str) {
        if (intent == null) {
    ...
    public static g zze(Bundle bundle, String str) {
        if (bundle == null) {
            return new g(0, (String) null);
        }
        return new g(zzl(bundle, "BillingClient"), bundle.getString("IN_APP_MESSAGE_PURCHASE_TOKEN"));
    }
