    ...
    public final zzdp zza(Class cls) {
        ...
        if (zzb2.zzb()) {
            if (cls2.isAssignableFrom(cls)) {
                return zzdj.zzc(zzdr.zzz(), zzbq.zzb(), zzb2.zza());
            }
            return zzdj.zzc(zzdr.zzy(), zzbq.zza(), zzb2.zza());
        } else if (cls2.isAssignableFrom(cls)) {
            if (zzb(zzb2)) {
                return zzdi.zzl(cls, zzb2, zzdl.zzb(), zzct.zzd(), zzdr.zzz(), zzbq.zzb(), zzdb.zzb());
            }
            return zzdi.zzl(cls, zzb2, zzdl.zzb(), zzct.zzd(), zzdr.zzz(), (zzbo) null, zzdb.zzb());
        } else if (zzb(zzb2)) {
            return zzdi.zzl(cls, zzb2, zzdl.zza(), zzct.zzc(), zzdr.zzy(), zzbq.zza(), zzdb.zza());
        } else {
            return zzdi.zzl(cls, zzb2, zzdl.zza(), zzct.zzc(), zzdr.zzy(), (zzbo) null, zzdb.zza());
        }
    }
}
