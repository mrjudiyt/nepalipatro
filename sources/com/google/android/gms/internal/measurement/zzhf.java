...
public abstract class zzhf<MessageType extends zzhd<MessageType, BuilderType>, BuilderType extends zzhf<MessageType, BuilderType>> implements zzkm {
    /* renamed from: zza */
    public abstract BuilderType zzb(zzib zzib, zzik zzik);
    ...
    public BuilderType zza(byte[] bArr, int i10, int i11, zzik zzik) {
        try {
            zzib zza = zzib.zza(bArr, 0, i11, false);
            zzb(zza, zzik);
            zza.zzb(0);
    ...
    public final /* synthetic */ zzkm zza(byte[] bArr, zzik zzik) {
