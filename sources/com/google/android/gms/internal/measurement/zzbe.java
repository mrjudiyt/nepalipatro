        ...
        switch (c10) {
            ...
            case 10:
                ...
                if (!list.isEmpty()) {
                    ...
                    str2 = ((zza13 instanceof zzao) || (zza13 instanceof zzax)) ? "" : zza13.zzf();
                } else {
                    str2 = ",";
                }
            ...
            case 16:
                ...
                if (zza19 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                    d10 = Math.max(zza19 + zzb7, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                } else {
                    d10 = Math.min(zza19, zzb7);
                }
                if (list.size() == 2) {
                    double zza20 = zzg.zza(zzh16.zza(list15.get(1)).zze().doubleValue());
                    if (zza20 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                        zzb7 = Math.max(zzb7 + zza20, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                    } else {
            ...
            case 19:
                ...
                if (list.size() > 1) {
                    ...
                    d11 = zza22 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? ((double) zzaf.zzb()) + zza22 : zza22;
                }
