...
final class zzif implements zzlc {
    ...
    public final int zzc() {
        ...
        int i11 = this.zzb;
        return (i11 == 0 || i11 == this.zzc) ? Api.BaseClientBuilder.API_PRIORITY_OTHER : i11 >>> 3;
    }
    ...
    private final <T> void zzd(T t10, zzlb<T> zzlb, zzik zzik) {
    ...
    private final <T> T zzb(zzlb<T> zzlb, zzik zzik) {
        T zza2 = zzlb.zza();
        zzd(zza2, zzlb, zzik);
        zzlb.zzc(zza2);
        return zza2;
    ...
    private final Object zza(zzmn zzmn, Class<?> cls, zzik zzik) {
    ...
    private final <T> void zzc(T t10, zzlb<T> zzlb, zzik zzik) {
        int i10 = this.zzc;
    ...
    public final <T> void zzb(T t10, zzlb<T> zzlb, zzik zzik) {
        zzb(2);
        zzd(t10, zzlb, zzik);
    }
    ...
    public final <T> void zzb(List<T> list, zzlb<T> zzlb, zzik zzik) {
        int zzi;
        int i10 = this.zzb;
        if ((i10 & 7) == 2) {
            do {
    ...
    private final <T> T zza(zzlb<T> zzlb, zzik zzik) {
        T zza2 = zzlb.zza();
        zzc(zza2, zzlb, zzik);
        zzlb.zzc(zza2);
        return zza2;
    ...
    public final <T> void zza(T t10, zzlb<T> zzlb, zzik zzik) {
        zzb(3);
        zzc(t10, zzlb, zzik);
    }
    ...
    @Deprecated
    public final <T> void zza(List<T> list, zzlb<T> zzlb, zzik zzik) {
        int zzi;
        int i10 = this.zzb;
        if ((i10 & 7) == 3) {
            do {
