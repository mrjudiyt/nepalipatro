...
public final class zzba extends zzay {
    ...
    private static boolean zzb(zzaq zzaq, zzaq zzaq2) {
        ...
        return !Double.isNaN(doubleValue) && !Double.isNaN(doubleValue2) && !(doubleValue == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && doubleValue2 == -0.0d) && (!(doubleValue == -0.0d && doubleValue2 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) && Double.compare(doubleValue, doubleValue2) < 0);
    }
