...
public final class zzg {
    ...
    public static long zzc(double d10) {
        return ((long) zzb(d10)) & KeyboardMap.kValueMask;
    }
    ...
    public static boolean zzb(zzaq zzaq) {
        ...
        Double zze = zzaq.zze();
        if (zze.isNaN() || zze.doubleValue() < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || !zze.equals(Double.valueOf(Math.floor(zze.doubleValue())))) {
            return false;
        }
        return true;
    }
