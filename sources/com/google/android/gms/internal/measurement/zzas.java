...
public final class zzas implements zzaq, Iterable<zzaq> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:165:0x044b, code lost:
        if (r7 >= com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) goto L_0x0458;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:166:0x044d, code lost:
        r7 = java.lang.Math.max(((double) r3.length()) + r7, com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:173:0x0487, code lost:
        if (r7 >= com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) goto L_0x0494;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:174:0x0489, code lost:
        r0 = java.lang.Math.max(((double) r3.length()) + r7, com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
     */
