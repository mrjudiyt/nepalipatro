...
final class zzij implements zzmw {
    ...
    public final void zzb(int i10, Object obj, zzlb zzlb) {
    ...
    public final void zzb(int i10, List<?> list, zzlb zzlb) {
    ...
    public final void zza(int i10, Object obj, zzlb zzlb) {
        zzig zzig = this.zza;
        zzig.zzc(i10, 3);
    ...
    public final void zza(int i10, List<?> list, zzlb zzlb) {
        for (int i11 = 0; i11 < list.size(); i11++) {
            zza(i10, (Object) list.get(i11), zzlb);
        }
    }

    public final <K, V> void zza(int i10, zzke<K, V> zzke, Map<K, V> map) {
