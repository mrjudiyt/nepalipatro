...
public final class zzgv {
    ...
    final boolean zzf;
    final boolean zzg;
    final h<Context, Boolean> zzh;
    private final boolean zzi;

    public zzgv(Uri uri) {
        this((String) null, uri, "", "", false, false, false, false, (h<Context, Boolean>) null);
    }
    ...
    public final zzgv zzb() {
        if (this.zzc.isEmpty()) {
            h<Context, Boolean> hVar = this.zzh;
            if (hVar == null) {
    ...
    private zzgv(String str, Uri uri, String str2, String str3, boolean z10, boolean z11, boolean z12, boolean z13, h<Context, Boolean> hVar) {
        this.zza = str;
        this.zzb = uri;
        this.zzc = str2;
        this.zzd = str3;
