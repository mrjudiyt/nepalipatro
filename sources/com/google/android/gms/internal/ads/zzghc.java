...
public final class zzghc {
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i11 < length) {
                ...
                long zzc = (((j44 & j37) | (j38 & 67108863 & j45) | (j46 << 26)) & KeyboardMap.kValueMask) + zzc(bArr3, 16);
                long zzc2 = (((j46 >> 6) | (j47 << 20)) & KeyboardMap.kValueMask) + zzc(bArr3, 20);
                long zzc3 = (((j47 >> 12) | (j48 << 14)) & KeyboardMap.kValueMask) + zzc(bArr3, 24);
                long zzc4 = (((j48 >> 18) | (j49 << 8)) & KeyboardMap.kValueMask) + zzc(bArr3, 28);
                byte[] bArr6 = new byte[16];
                zzd(bArr6, zzc & KeyboardMap.kValueMask, 0);
                long j50 = zzc2 + (zzc >> 32);
                zzd(bArr6, j50 & KeyboardMap.kValueMask, 4);
                long j51 = zzc3 + (j50 >> 32);
                zzd(bArr6, j51 & KeyboardMap.kValueMask, 8);
                zzd(bArr6, (zzc4 + (j51 >> 32)) & KeyboardMap.kValueMask, 12);
                return bArr6;
            }
        }
    }
    ...
    private static long zzc(byte[] bArr, int i10) {
        ...
        return ((long) (((bArr[i10 + 3] & 255) << 24) | i11 | (bArr[i10] & 255) | ((bArr[i10 + 2] & 255) << 16))) & KeyboardMap.kValueMask;
    }
