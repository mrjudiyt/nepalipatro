...
public final class zzed implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzed(Handler handler, zzec zzec) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i10) {
        ...
        zzeg.zzb(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr2 = new int[2];
        zzeg.zzb(EGL14.eglInitialize(eglGetDisplay, iArr2, 0, iArr2, 1), "eglInitialize failed");
        this.zzd = eglGetDisplay;
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArr3 = new int[1];
        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, zza, 0, eGLConfigArr, 0, 1, iArr3, 0);
        zzeg.zzb(eglChooseConfig && iArr3[0] > 0 && eGLConfigArr[0] != null, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr3[0]), eGLConfigArr[0]}));
        ...
        zzeg.zzb(eglCreateContext != null, "eglCreateContext failed");
        ...
        if (i10 == 1) {
            ...
            zzeg.zzb(eGLSurface != null, "eglCreatePbufferSurface failed");
        }
        zzeg.zzb(EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
