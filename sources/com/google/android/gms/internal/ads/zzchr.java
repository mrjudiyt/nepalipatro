...
public abstract class zzchr extends zzaun implements zzchs {
    ...
    public final boolean zzbJ(int i10, Parcel parcel, Parcel parcel2, int i11) {
        switch (i10) {
            ...
            case 2:
                zzauo.zzc(parcel);
                Bundle zzd = zzd((Bundle) zzauo.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                zzauo.zze(parcel2, zzd);
                return true;
            case 3:
                zzauo.zzc(parcel);
                zzo(parcel.readString(), parcel.readString(), (Bundle) zzauo.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                return true;
            case 4:
            ...
            case 8:
                zzauo.zzc(parcel);
                zzm(parcel.readString(), parcel.readString(), (Bundle) zzauo.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                return true;
            case 9:
