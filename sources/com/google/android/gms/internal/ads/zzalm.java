...
public final class zzalm {
                ...
                if (zza >= longValue) {
                    ...
                    if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                        ...
                        if (j11 < ((long) allocate.capacity()) || j11 > 2147483639) {
                            throw new zzalj("APK Signing Block size out of range: " + j11);
                        }
                        int i11 = (int) (8 + j11);
                        ...
                        if (j12 >= 0) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (j14 < 4 || j14 > 2147483647L) {
                                                        throw new zzalj("APK Signing Block entry #" + i10 + " size out of range: " + j14);
                                                    }
                                                    int i12 = (int) j14;
                                                    int position2 = slice.position() + i12;
                                                    if (i12 > slice.remaining()) {
                                                        throw new zzalj("APK Signing Block entry #" + i10 + " size out of range: " + i12 + ", available: " + slice.remaining());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzali(zze(slice, i12 - 4), longValue2, zza, longValue, byteBuffer2, (zzalh) null));
                                                    ...
                                                    throw new zzalj("Insufficient data to read size of APK Signing Block entry #" + i10);
                                                }
                                            }
                            ...
                            throw new zzalj("APK Signing Block sizes in header and footer do not match: " + j13 + " vs " + j11);
                        }
                        throw new zzalj("APK Signing Block offset out of range: " + j12);
                    }
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j10, long j11, long j12, ByteBuffer byteBuffer) {
        if (!map.isEmpty()) {
            zzalg zzalg = new zzalg(fileChannel, 0, j10);
            zzalg zzalg2 = new zzalg(fileChannel, j11, j12 - j11);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j13 = j10;
            zzaln.zzd(duplicate, j10);
            zzale zzale = new zzale(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] zzk = zzk(iArr, new zzalf[]{zzalg, zzalg2, zzale});
                while (i10 < size) {
                    int i12 = iArr[i10];
                    Map map2 = map;
                    ...
                    if (arrayList.equals(arrayList2)) {
                        ...
                        if (bArr3 == null || MessageDigest.isEqual(bArr3, bArr)) {
                            ...
                            while (zzf6.hasRemaining()) {
                                ...
                                byte[] zzi2 = zzi(zzf6);
                                try {
                                    arrayList3.add(new zzalk((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(zzi2)), zzi2));
    ...
    private static byte[][] zzk(int[] iArr, zzalf[] zzalfArr) {
        long j10;
        int i10;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j12 += (zzalfArr[i12].zza() + 1048575) / 1048576;
            i12++;
        }
        if (j12 < 2097151) {
            ...
            for (i10 = 3; i16 < i10; i10 = 3) {
                ...
                while (zza > j11) {
                    ...
                    long j14 = j13;
                    try {
                        zzalf.zzb(messageDigestArr, j14, min);
                        byte[] bArr4 = bArr3;
                        int i19 = 0;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzali zzali) {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer zzf = zzf(zzali.zza);
                int i10 = 0;
                ...
                if (i10 <= 0) {
                    ...
                    zzh(hashMap, fileChannel, zzali.zzb, zzali.zzc, zzali.zzd, zzali.zze);
