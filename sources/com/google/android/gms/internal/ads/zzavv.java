...
public final class zzavv extends Thread {
    ...
    public zzavv() {
        ...
        this.zzj = ((Integer) zzba.zzc().zzb(zzbci.zzS)).intValue();
        this.zzk = ((Integer) zzba.zzc().zzb(zzbci.zzT)).intValue();
        this.zzl = ((Integer) zzba.zzc().zzb(zzbci.zzU)).intValue();
        this.zze = ((Long) zzbdt.zzf.zze()).intValue();
        this.zzm = (String) zzba.zzc().zzb(zzbci.zzW);
        this.zzn = ((Boolean) zzba.zzc().zzb(zzbci.zzX)).booleanValue();
        this.zzo = ((Boolean) zzba.zzc().zzb(zzbci.zzY)).booleanValue();
        this.zzp = ((Boolean) zzba.zzc().zzb(zzbci.zzZ)).booleanValue();
    ...
    public final void run() {
        /*
            r6 = this;
        L_0x0000:
            com.google.android.gms.internal.ads.zzavq r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ all -> 0x00a8 }
        ...
        L_0x002a:
            ...
            if (r0 == 0) goto L_0x00b2
            com.google.android.gms.internal.ads.zzavq r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            android.app.Activity r0 = r0.zza()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            if (r0 != 0) goto L_0x006d
            java.lang.String r0 = "ContentFetchThread: no activity. Sleeping."
            com.google.android.gms.internal.ads.zzcat.zze(r0)     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x008e:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcac r2 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x009d:
            ...
            com.google.android.gms.internal.ads.zzavr r0 = new com.google.android.gms.internal.ads.zzavr     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00a8:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcac r1 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00dc:
            ...
            com.google.android.gms.internal.ads.zzcat.zze(r1)     // Catch:{ InterruptedException -> 0x00dc }
    ...
    public final zzavu zzb(View view, zzavl zzavl) {
        if (view == null) {
        ...
        if ((view instanceof TextView) && !(view instanceof EditText)) {
            ...
            zzavl.zzk(text.toString(), globalVisibleRect, view.getX(), view.getY(), (float) view.getWidth(), (float) view.getHeight());
            return new zzavu(this, 1, 0);
        } else if ((view instanceof WebView) && !(view instanceof zzcgb)) {
            WebView webView = (WebView) view;
            if (!PlatformVersion.isAtLeastKitKat()) {
                return new zzavu(this, 0, 0);
            }
            zzavl.zzh();
            webView.post(new zzavt(this, zzavl, webView, globalVisibleRect));
            ...
            for (int i12 = 0; i12 < viewGroup.getChildCount(); i12++) {
                zzavu zzb2 = zzb(viewGroup.getChildAt(i12), zzavl);
                i10 += zzb2.zza;
                i11 += zzb2.zzb;
            }
            return new zzavu(this, i10, i11);
        }
    }
    ...
    public final void zzc(android.view.View r11) {
        /*
            r10 = this;
            com.google.android.gms.internal.ads.zzavl r9 = new com.google.android.gms.internal.ads.zzavl     // Catch:{ Exception -> 0x0083 }
            ...
            com.google.android.gms.internal.ads.zzavq r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ Exception -> 0x0083 }
            ...
            com.google.android.gms.internal.ads.zzbca r2 = com.google.android.gms.internal.ads.zzbci.zzV     // Catch:{ Exception -> 0x0083 }
            com.google.android.gms.internal.ads.zzbcg r3 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ Exception -> 0x0083 }
        ...
        L_0x0053:
            return
        L_0x0054:
            com.google.android.gms.internal.ads.zzavu r11 = r10.zzb(r11, r9)     // Catch:{ Exception -> 0x0083 }
        ...
        L_0x0073:
            com.google.android.gms.internal.ads.zzavm r11 = r10.zzd     // Catch:{ Exception -> 0x0083 }
    ...
    /* access modifiers changed from: package-private */
    public final void zzd(zzavl zzavl, WebView webView, String str, boolean z10) {
        zzavl.zzg();
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString(ViewHierarchyConstants.TEXT_KEY);
                if (this.zzn || TextUtils.isEmpty(webView.getTitle())) {
                    zzavl.zzl(optString, z10, webView.getX(), webView.getY(), (float) webView.getWidth(), (float) webView.getHeight());
                } else {
