...
public final class zzrz {
    ...
    zzrz(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15) {
    ...
    private final void zzj(String str) {
        ...
        zzer.zzb("MediaCodecInfo", "NoSupport [" + str + "] [" + this.zza + ", " + this.zzb + "] [" + str2 + "]");
    }
    ...
    private final boolean zzl(com.google.android.gms.internal.ads.zzam r12, boolean r13) {
        /*
            r11 = this;
            android.util.Pair r0 = com.google.android.gms.internal.ads.zzst.zzb(r12)
            r1 = 1
        ...
        L_0x00e6:
            ...
            java.lang.String r9 = com.google.android.gms.internal.ads.zzfk.zzb
        ...
        L_0x0107:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzrz.zzl(com.google.android.gms.internal.ads.zzam, boolean):boolean");
    }

    private final boolean zzm(zzam zzam) {
        return this.zzb.equals(zzam.zzm) || this.zzb.equals(zzst.zze(zzam));
    }
    ...
    public final zzie zzb(zzam zzam, zzam zzam2) {
        int i10 = true != zzfk.zzE(zzam.zzm, zzam2.zzm) ? 8 : 0;
        if (this.zzh) {
            ...
            if (!zzfk.zzE(zzam.zzy, zzam2.zzy)) {
                i10 |= 2048;
            }
            String str = this.zza;
            if (zzfk.zzd.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(str) && !zzam.zzd(zzam2)) {
                i10 |= 2;
            }
            if (i10 == 0) {
                return new zzie(this.zza, zzam, zzam2, true != zzam.zzd(zzam2) ? 2 : 3, 0);
            }
        } else {
            ...
            if (i10 == 0) {
                return new zzie(this.zza, zzam, zzam2, 1, 0);
            }
        }
        return new zzie(this.zza, zzam, zzam2, 0, i10);
    }
    ...
    public final boolean zze(zzam zzam) {
        int i10;
        int i11;
        boolean z10 = false;
        ...
        if (this.zzh) {
            int i12 = zzam.zzr;
            if (i12 <= 0 || (i11 = zzam.zzs) <= 0) {
                return true;
            }
            if (zzfk.zza >= 21) {
                return zzg(i12, i11, (double) zzam.zzt);
            }
            if (i12 * i11 <= zzst.zza()) {
                z10 = true;
            }
                ...
                if (codecCapabilities2 == null) {
                    ...
                    if (audioCapabilities2 == null) {
                        ...
                        if (maxInputChannelCount <= 1 && ((i15 < 26 || maxInputChannelCount <= 0) && !"audio/mpeg".equals(str2) && !"audio/3gpp".equals(str2) && !"audio/amr-wb".equals(str2) && !"audio/mp4a-latm".equals(str2) && !"audio/vorbis".equals(str2) && !"audio/opus".equals(str2) && !"audio/raw".equals(str2) && !"audio/flac".equals(str2) && !"audio/g711-alaw".equals(str2) && !"audio/g711-mlaw".equals(str2) && !"audio/gsm".equals(str2))) {
                            ...
                            zzer.zzf("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + maxInputChannelCount + " to " + i10 + "]");
    ...
    public final boolean zzg(int i10, int i11, double d10) {
        ...
        if (zzfk.zza >= 29) {
            int zza2 = zzry.zza(videoCapabilities, i10, i11, d10);
            if (zza2 == 2) {
                return true;
            }
            if (zza2 == 1) {
        ...
        if (!zzk(videoCapabilities, i10, i11, d10)) {
            ...
            zzer.zzb("MediaCodecInfo", "AssumedSupport [" + ("sizeAndRate.rotated, " + i10 + "x" + i11 + "@" + d10) + "] [" + this.zza + ", " + this.zzb + "] [" + zzfk.zze + "]");
        }
        return true;
    }
    ...
    public final android.media.MediaCodecInfo.CodecProfileLevel[] zzh() {
        ...
        L_0x000b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzrz.zzh():android.media.MediaCodecInfo$CodecProfileLevel[]");
    }
}
