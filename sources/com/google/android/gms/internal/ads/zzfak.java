...
public final class zzfak implements zzhbc {
    ...
    public zzfak(zzhbp zzhbp, zzhbp zzhbp2, zzhbp zzhbp3) {
        this.zza = zzhbp;
        this.zzb = zzhbp2;
        this.zzc = zzhbp3;
    }
    ...
    public final zzfai zzb() {
        ...
        if (((Integer) zzba.zzc().zzb(zzbci.zzgD)).intValue() > 0) {
            if (!((Boolean) zzba.zzc().zzb(zzbci.zzgm)).booleanValue() || z10) {
                zzffn zza2 = zzffo.zza(zzffe.AppOpen, context, zzfew, new zzezm(new zzezj()));
