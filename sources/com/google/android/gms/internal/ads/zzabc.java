...
public final class zzabc implements zzabn {
    ...
    public zzabc(zzt zzt, long j10, long j11) {
        this.zzb = zzt;
        this.zzd = j10;
        this.zzc = j11;
    }
    ...
    private final void zzt(int i10) {
        ...
        if (i11 > length) {
            this.zze = Arrays.copyOf(this.zze, Math.max(NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST + i11, Math.min(length + length, i11 + 524288)));
        }
    }
