...
final class zzcfr extends zzgc implements zzhf {
    ...
    private final zzhe zzf = new zzhe();
    private zzgn zzg;
    ...
    zzcfr(String str, zzhk zzhk, int i10, int i11, long j10, long j11) {
        super(true);
        zzdx.zzc(str);
        this.zze = str;
        this.zzc = i10;
    ...
    public final int zza(byte[] bArr, int i10, int i11) {
        ...
        try {
            ...
            throw new zzhb(e10, this.zzg, 2000, 2);
        }
    }
    ...
    public final long zzb(zzgn zzgn) {
        ...
        throw new zzcfp(headerField, zzgn);
    }
    ...
    public final void zzd() {
        try {
            ...
            throw new zzhb(e10, this.zzg, 2000, 3);
        } catch (Throwable th) {
            this.zzj = null;
            zzl();
            if (this.zzk) {
        ...
        try {
            ...
            try {
                ...
                if (responseCode < 200 || responseCode > 299) {
                    ...
                    zzl();
                    throw new zzcfq(this.zzl, headerFields, this.zzg, i10);
                }
                try {
                    ...
                    zzl();
                    throw new zzhb(e10, this.zzg, 2000, i10);
                }
            } catch (IOException e11) {
                zzl();
                String valueOf = String.valueOf(uri2);
                zzgn zzgn = this.zzg;
                throw new zzhb("Unable to connect to ".concat(valueOf), e11, zzgn, 2000, i10);
            }
        } catch (IOException e12) {
            IOException iOException = e12;
            String valueOf2 = String.valueOf(uri);
            throw new zzhb("Unable to connect to ".concat(valueOf2), iOException, this.zzg, 2000, i10);
        }
    }
}
