...
final class zzccz implements SensorEventListener {
    ...
    public final void zza(zzccy zzccy) {
        this.zzh = zzccy;
    }
    ...
    public final void zzb() {
        if (this.zzg == null) {
            ...
            handlerThread.start();
            zzfps zzfps = new zzfps(handlerThread.getLooper());
            this.zzg = zzfps;
            if (!this.zza.registerListener(this, defaultSensor, 0, zzfps)) {
