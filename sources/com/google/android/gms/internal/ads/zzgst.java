...
final class zzgst extends zzgsz {
    ...
    /* synthetic */ zzgst(byte[] bArr, int i10, int i11, boolean z10, zzgss zzgss) {
        super((zzgsy) null);
        this.zze = bArr;
        this.zzf = i11 + i10;
        this.zzh = i10;
    ...
    public final zzgsr zzw() {
        ...
        if (zzj2 > 0) {
            ...
            int i11 = this.zzh;
            if (zzj2 <= i10 - i11) {
                zzgsr zzv = zzgsr.zzv(this.zze, i11, zzj2);
                this.zzh += zzj2;
                return zzv;
            }
        }
        ...
        if (zzj2 > 0) {
            ...
            if (zzj2 <= i12 - i13) {
                int i14 = zzj2 + i13;
                this.zzh = i14;
                return new zzgsn(Arrays.copyOfRange(this.zze, i13, i14));
            }
        }
        if (zzj2 <= 0) {
            throw zzgul.zzf();
    ...
    public final String zzx() {
        ...
        if (zzj2 > 0) {
            ...
            int i11 = this.zzh;
            if (zzj2 <= i10 - i11) {
                String str = new String(this.zze, i11, zzj2, zzguj.zzb);
                this.zzh += zzj2;
                return str;
            }
        }
    ...
    public final String zzy() {
        ...
        if (zzj2 > 0) {
            ...
            int i11 = this.zzh;
            if (zzj2 <= i10 - i11) {
                String zzh2 = zzgxi.zzh(this.zze, i11, zzj2);
                this.zzh += zzj2;
                return zzh2;
            }
        }
