...
public final class zzig {
    ...
    /* synthetic */ zzig(float f10, float f11, long j10, float f12, long j11, long j12, float f13, zzif zzif) {
        this.zza = j11;
        this.zzb = j12;
    }
    ...
    public final float zza(long j10, long j11) {
        ...
        if (this.zzh > j15) {
            float zzq = (float) zzfk.zzq(1000);
            long[] jArr = {j15, this.zze, this.zzh - (((long) ((this.zzk - 4.0f) * zzq)) + ((long) ((this.zzi - 4.0f) * zzq)))};
            j12 = jArr[0];
            ...
            j12 = Math.max(this.zzh, Math.min(j10 - ((long) (Math.max(0.0f, this.zzk - 4.0f) / 1.0E-7f)), j15));
            this.zzh = j12;
            long j17 = this.zzg;
        ...
        float max2 = Math.max(this.zzj, Math.min((((float) j18) * 1.0E-7f) + 1.0f, this.zzi));
        this.zzk = max2;
        return max2;
    }
