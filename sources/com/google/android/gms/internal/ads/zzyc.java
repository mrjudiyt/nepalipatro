...
public final class zzyc implements zzxy, zzhk {
    ...
    /* synthetic */ zzyc(Context context, Map map, int i10, zzdy zzdy, boolean z10, zzyb zzyb) {
            ...
            if (zzg == null) {
                ...
                if (!(context == null || (telephonyManager = (TelephonyManager) context.getSystemService("phone")) == null)) {
                    ...
                    if (!TextUtils.isEmpty(networkCountryIso)) {
                        str = zzfsc.zzb(networkCountryIso);
                        int[] zzm2 = zzm(str);
                        HashMap hashMap = new HashMap(8);
                        hashMap.put(0, 1000000L);
                        zzfvs zzfvs = zza;
                        hashMap.put(2, (Long) zzfvs.get(zzm2[0]));
                        ...
                        hashMap.put(7, (Long) zzfvs.get(zzm2[0]));
                        zzg = new zzyc(context2, hashMap, 2000, zzdy.zza, true, (zzyb) null);
                    }
                }
                str = zzfsc.zzb(Locale.getDefault().getCountry());
                int[] zzm22 = zzm(str);
                HashMap hashMap2 = new HashMap(8);
                hashMap2.put(0, 1000000L);
                zzfvs zzfvs2 = zza;
                hashMap2.put(2, (Long) zzfvs2.get(zzm22[0]));
                ...
                hashMap2.put(7, (Long) zzfvs2.get(zzm22[0]));
                zzg = new zzyc(context2, hashMap2, 2000, zzdy.zza, true, (zzyb) null);
            }
            zzyc = zzg;
        }
        return zzyc;
    ...
    public final synchronized void zzk(int r9) {
        ...
        L_0x002a:
            ...
            com.google.android.gms.internal.ads.zzyr r9 = r8.zzj     // Catch:{ all -> 0x0045 }
        ...
        L_0x0045:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzyc.zzk(int):void");
    }

    private static boolean zzl(zzgn zzgn, boolean z10) {
        return z10 && !zzgn.zza(8);
    }
    ...
    public final synchronized void zza(zzgi zzgi, zzgn zzgn, boolean z10, int i10) {
        if (zzl(zzgn, z10)) {
            this.zzn += (long) i10;
        }
    }

    public final synchronized void zzb(zzgi zzgi, zzgn zzgn, boolean z10) {
        if (zzl(zzgn, z10)) {
            zzdx.zzf(this.zzl > 0);
    ...
    public final synchronized void zzd(zzgi zzgi, zzgn zzgn, boolean z10) {
        if (zzl(zzgn, z10)) {
            if (this.zzl == 0) {
    ...
    public final void zze(Handler handler, zzxx zzxx) {
        Objects.requireNonNull(zzxx);
        this.zzi.zza(handler, zzxx);
    }

    public final void zzf(zzxx zzxx) {
        this.zzi.zzc(zzxx);
    }
}
