...
public final class zzfmq {
    ...
    zzfmq(Context context, Executor executor, Task task, boolean z10) {
        this.zzb = context;
        this.zzc = executor;
        this.zzd = task;
        this.zze = z10;
    ...
    public static zzfmq zza(Context context, Executor executor, boolean z10) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        if (z10) {
            executor.execute(new zzfmo(context, taskCompletionSource));
        } else {
            executor.execute(new zzfmp(taskCompletionSource));
        }
        return new zzfmq(context, executor, taskCompletionSource.getTask(), z10);
    }
    ...
    private final Task zzh(int i10, long j10, Exception exc, String str, Map map, String str2) {
        ...
        return this.zzd.continueWith(this.zzc, new zzfmn(zza2, i10));
    }
