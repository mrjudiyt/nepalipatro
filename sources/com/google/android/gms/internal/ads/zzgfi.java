...
final class zzgfi {
    ...
    static {
        ...
        zzb = zza2;
        zzc = zzgiq.zzb(zzgfe.zza, zzgfd.class, cls2);
        zzd = zzgim.zza(zzgff.zza, zza2, cls2);
        zze = zzght.zza(zzgfg.zza, zzgev.class, cls);
        zzf = zzghp.zzb(zzgfh.zza, zza2, cls);
    }

    public static void zza(zzgii zzgii) {
        zzgii.zzg(zzc);
        zzgii.zzf(zzd);
        zzgii.zze(zze);
        zzgii.zzd(zzf);
