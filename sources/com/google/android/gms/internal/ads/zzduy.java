...
public final class zzduy implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzba.zzc().zzb(zzbci.zziO)).booleanValue()) {
            long currentTimeMillis = zzt.zzB().currentTimeMillis();
            if (this.zze + ((long) ((Integer) zzba.zzc().zzb(zzbci.zziQ)).intValue()) < currentTimeMillis) {
                this.zzf = 0;
            ...
            float f10 = this.zzc;
            zzbca zzbca = zzbci.zziP;
            if (floatValue > f10 + ((Float) zzba.zzc().zzb(zzbca)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else if (this.zzd.floatValue() < this.zzc - ((Float) zzba.zzc().zzb(zzbca)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzg = true;
            }
            ...
            if (this.zzg && this.zzh) {
                ...
                this.zzg = false;
                this.zzh = false;
                zzdux zzdux = this.zzi;
                if (zzdux != null) {
                    if (i10 == ((Integer) zzba.zzc().zzb(zzbci.zziR)).intValue()) {
                        zzdvm zzdvm = (zzdvm) zzdux;
                        zzdvm.zzh(new zzdvk(zzdvm), zzdvl.GESTURE);
                    }
                }
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0038, code lost:
        com.google.android.gms.internal.ads.zzcat.zzj("Flick detection failed to initialize. Failed to obtain gyroscope.");
     */
    ...
    public final void zzb() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.google.android.gms.internal.ads.zzbca r0 = com.google.android.gms.internal.ads.zzbci.zziO     // Catch:{ all -> 0x003e }
            com.google.android.gms.internal.ads.zzbcg r1 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzduy.zzb():void");
    }

    public final void zzc(zzdux zzdux) {
        this.zzi = zzdux;
    }
}
