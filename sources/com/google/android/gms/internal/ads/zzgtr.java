...
public enum zzgtr {
    ...
    private static final zzgtr[] zzZ = null;
    private final zzgun zzab;
    ...
    static {
        int i10;
        zzZ = new zzgtr[r1];
        for (zzgtr zzgtr : values()) {
            zzZ[zzgtr.zzac] = zzgtr;
        }
    }

    private zzgtr(int i10, int i11, zzgun zzgun) {
        this.zzac = i10;
        this.zzab = zzgun;
        int i12 = i11 - 1;
        if (i12 == 1) {
