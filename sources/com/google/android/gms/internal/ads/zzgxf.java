...
abstract class zzgxf {
    ...
    static final String zzd(ByteBuffer byteBuffer, int i10, int i11) {
        if ((((byteBuffer.limit() - i10) - i11) | i10 | i11) >= 0) {
            ...
            while (r11 < i12) {
                ...
                if (zzgxe.zzd(b11)) {
                    ...
                    if (i15 < i12) {
                        zzgxe.zzc(b11, byteBuffer.get(i15), cArr, i14);
                        i14++;
                        r11 = i15 + 1;
                    } else {
                        throw zzgul.zzd();
                    ...
                    if (i15 < i12 - 1) {
                        int i17 = i15 + 1;
                        zzgxe.zzb(b11, byteBuffer.get(i15), byteBuffer.get(i17), cArr, i14);
                        i14++;
                        r11 = i17 + 1;
                    } else {
                        throw zzgul.zzd();
                    ...
                    int i19 = i18 + 1;
                    zzgxe.zza(b11, b13, byteBuffer.get(i18), byteBuffer.get(i19), cArr, i14);
                    i14 += 2;
                    r11 = i19 + 1;
                } else {
                    throw zzgul.zzd();
