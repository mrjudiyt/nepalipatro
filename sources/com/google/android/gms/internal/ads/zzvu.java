...
final class zzvu {
    ...
    public final java.lang.Object zza(int r4) {
        ...
        L_0x0038:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzvu.zza(int):java.lang.Object");
    }
    ...
    public final void zzc(int i10, Object obj) {
        ...
        if (this.zzb.size() > 0) {
            ...
            if (keyAt == i10) {
                ...
                zzvn.zzm((zzvl) sparseArray2.valueAt(sparseArray2.size() - 1));
            }
        }
    ...
    public final void zzd() {
        for (int i10 = 0; i10 < this.zzb.size(); i10++) {
            zzvn.zzm((zzvl) this.zzb.valueAt(i10));
        }
        this.zza = -1;
        this.zzb.clear();
    }
    ...
    public final void zze(int i10) {
        ...
        while (i11 < this.zzb.size() - 1) {
            ...
            if (i10 >= this.zzb.keyAt(i12)) {
                zzvn.zzm((zzvl) this.zzb.valueAt(i11));
