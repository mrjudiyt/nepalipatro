...
final class zzgsv extends zzgsz {
    ...
    /* synthetic */ zzgsv(Iterable iterable, int i10, boolean z10, zzgsu zzgsu) {
        super((zzgsy) null);
        this.zzh = i10;
        this.zze = iterable;
    ...
    private final void zzL(byte[] bArr, int i10, int i11) {
        if (i11 <= zzJ()) {
            ...
            while (i12 > 0) {
                ...
                long j10 = (long) min;
                zzgxd.zzo(this.zzm, bArr, (long) (i11 - i12), j10);
                i12 -= min;
                this.zzm += j10;
            }
        } else if (i11 > 0) {
    ...
    public final int zzi() {
        ...
        if (j10 - j11 >= 4) {
            this.zzm = 4 + j11;
            return (zzgxd.zza(j11) & 255) | ((zzgxd.zza(1 + j11) & 255) << 8) | ((zzgxd.zza(2 + j11) & 255) << 16) | ((zzgxd.zza(j11 + 3) & 255) << 24);
        }
        return (zza() & 255) | ((zza() & 255) << 8) | ((zza() & 255) << 16) | ((zza() & 255) << 24);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0087, code lost:
        if (com.google.android.gms.internal.ads.zzgxd.zza(r4) >= 0) goto L_0x0089;
     */
    ...
    public final long zzq() {
        ...
        if (j10 - j11 >= 8) {
            this.zzm = 8 + j11;
            byte zza = zzgxd.zza(j11 + 5);
            long zza2 = (((long) zzgxd.zza(4 + j11)) & 255) << 32;
            byte zza3 = zzgxd.zza(j11 + 6);
            return (((long) zzgxd.zza(j11)) & 255) | ((((long) zzgxd.zza(1 + j11)) & 255) << 8) | ((((long) zzgxd.zza(j11 + 2)) & 255) << 16) | ((((long) zzgxd.zza(j11 + 3)) & 255) << 24) | zza2 | ((((long) zza) & 255) << 40) | ((((long) zza3) & 255) << 48) | ((((long) zzgxd.zza(j11 + 7)) & 255) << 56);
        }
    ...
    public final long zzr() {
        ...
        if (this.zzo != j13) {
            long j14 = j13 + 1;
            byte zza = zzgxd.zza(j13);
            if (zza >= 0) {
                this.zzm++;
                return (long) zza;
            } else if (this.zzo - this.zzm >= 10) {
                long j15 = j14 + 1;
                byte zza2 = zza ^ (zzgxd.zza(j14) << 7);
                if (zza2 < 0) {
                    b10 = zza2 ^ Byte.MIN_VALUE;
                } else {
                    long j16 = j15 + 1;
                    byte zza3 = zza2 ^ (zzgxd.zza(j15) << 14);
                    if (zza3 >= 0) {
                        j10 = (long) (zza3 ^ 16256);
                    } else {
                        j15 = j16 + 1;
                        byte zza4 = zza3 ^ (zzgxd.zza(j16) << 21);
                        if (zza4 < 0) {
                            b10 = zza4 ^ -2080896;
                        } else {
                            j16 = j15 + 1;
                            long zza5 = ((long) zza4) ^ (((long) zzgxd.zza(j15)) << 28);
                            if (zza5 >= 0) {
                                j12 = 266354560;
                            } else {
                                long j17 = j16 + 1;
                                long zza6 = zza5 ^ (((long) zzgxd.zza(j16)) << 35);
                                if (zza6 < 0) {
                                    j11 = -34093383808L;
                                } else {
                                    j16 = j17 + 1;
                                    zza5 = zza6 ^ (((long) zzgxd.zza(j17)) << 42);
                                    if (zza5 >= 0) {
                                        j12 = 4363953127296L;
                                    } else {
                                        j17 = j16 + 1;
                                        zza6 = zza5 ^ (((long) zzgxd.zza(j16)) << 49);
                                        if (zza6 < 0) {
                                            j11 = -558586000294016L;
                                        } else {
                                            j16 = j17 + 1;
                                            j10 = (zza6 ^ (((long) zzgxd.zza(j17)) << 56)) ^ 71499008037633920L;
                                            if (j10 < 0) {
                                                long j18 = 1 + j16;
                                                if (((long) zzgxd.zza(j16)) >= 0) {
                                                    j15 = j18;
                                                    this.zzm = j15;
                                                    return j10;
                                                }
    ...
    public final String zzy() {
        ...
        if (zzj2 > 0) {
            ...
            long j12 = (long) zzj2;
            if (j12 <= j10 - j11) {
                String zzg2 = zzgxi.zzg(this.zzg, (int) (j11 - this.zzn), zzj2);
                this.zzm += j12;
                return zzg2;
            }
        }
