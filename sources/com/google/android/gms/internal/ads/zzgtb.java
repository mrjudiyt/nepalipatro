...
abstract class zzgtb extends zzgtg {
    final byte[] zza;
    final int zzb;
    int zzc;
    int zzd;
    ...
    public final void zzf(int i10) {
        if (zzgtg.zzb) {
            ...
            while ((i10 & -128) != 0) {
                ...
                int i11 = this.zzc;
                this.zzc = i11 + 1;
                zzgxd.zzq(bArr, (long) i11, (byte) ((i10 & 127) | 128));
                i10 >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i12 = this.zzc;
            this.zzc = i12 + 1;
            zzgxd.zzq(bArr2, (long) i12, (byte) i10);
        ...
        if (zzgtg.zzb) {
            ...
            while (true) {
                ...
                if ((j10 & -128) == 0) {
                    ...
                    int i11 = this.zzc;
                    this.zzc = i11 + 1;
                    zzgxd.zzq(bArr, (long) i11, (byte) i10);
                ...
                int i12 = this.zzc;
                this.zzc = i12 + 1;
                zzgxd.zzq(bArr2, (long) i12, (byte) ((i10 & 127) | 128));
                j10 >>>= 7;
            }
        } else {
            while (true) {
