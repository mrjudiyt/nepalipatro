...
final class zzgts extends zzgsb implements RandomAccess, zzgvq {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Api.BaseClientBuilder.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzgts.zzb, 0, this.zzb, this.zzc, zzgts.zzc);
            this.zzc = i12;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgts zzgts = (zzgts) obj;
        if (this.zzc != zzgts.zzc) {
            return false;
        }
        float[] fArr = zzgts.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgui zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzgts(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzgts(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
