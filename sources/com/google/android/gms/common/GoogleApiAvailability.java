...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final void zae(Context context, int i10, String str, PendingIntent pendingIntent) {
        ...
        if (i10 == 18) {
            ...
            l.e L = new l.e(context).D(true).l(true).r(zaf).L(new l.c().r(zae));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                L.J(context.getApplicationInfo().icon).H(2);
                ...
                L.J(17301642).N(resources.getString(R.string.common_google_play_services_notification_ticker)).Q(System.currentTimeMillis()).p(pendingIntent).q(zae);
            }
            if (PlatformVersion.isAtLeastO()) {
    ...
    public final boolean zah(Context context, ConnectionResult connectionResult, int i10) {
        ...
        zae(context, connectionResult.getErrorCode(), (String) null, zal.zaa(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i10, true), zal.zaa | 134217728));
        return true;
    }
