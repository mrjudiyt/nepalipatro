    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api next : this.zaj.keySet()) {
                ...
                boolean z11 = zad2.get(next) != null;
                aVar.put(next, Boolean.valueOf(z11));
                zat zat = new zat(next, z11);
                arrayList.add(zat);
            ...
            zabe zabe = new zabe(this.zai, new ReentrantLock(), this.zan, zaa2, this.zao, this.zap, aVar, this.zaq, this.zar, aVar2, this.zal, zabe.zad(aVar2.values(), true), arrayList);
