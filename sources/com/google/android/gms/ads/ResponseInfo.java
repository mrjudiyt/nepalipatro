...
public final class ResponseInfo {
    ...
    private ResponseInfo(zzdn zzdn) {
        ...
        if (zzdn != null) {
            try {
                ...
                zzcat.zzh("Could not forward getAdapterResponseInfo to ResponseInfo.", e10);
            }
        }
        zzdn zzdn2 = this.zza;
        if (zzdn2 != null) {
            try {
                ...
                zzcat.zzh("Could not forward getLoadedAdapterResponse to ResponseInfo.", e11);
            }
        }
    }
    ...
    public String getMediationAdapterClassName() {
        try {
            ...
            zzcat.zzh("Could not forward getMediationAdapterClassName to ResponseInfo.", e10);
            return null;
        }
    }
    ...
    public String getResponseId() {
        try {
            ...
            zzcat.zzh("Could not forward getResponseId to ResponseInfo.", e10);
            return null;
        }
    }
