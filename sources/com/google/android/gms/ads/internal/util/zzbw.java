...
public final class zzbw {
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            zzcat.zzj(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
    ...
    public static String zzl(zzfcx zzfcx) {
        if (zzfcx == null) {
            return null;
        }
        ...
        try {
            ...
            zzn(jsonWriter, zzfcx);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e10) {
            zzcat.zzh("Error when writing JSON.", e10);
            return null;
        }
    }
