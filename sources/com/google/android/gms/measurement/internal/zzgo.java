...
final class zzgo implements Runnable {
    ...
    public final void run() {
        ...
        zzgm.zza.zzy();
        if (zza3 != null) {
            long j10 = zza3.getLong("install_begin_timestamp_seconds", 0) * 1000;
            if (j10 == 0) {
