...
public final class zzhj extends zzfj {
    ...
    public final zzam zza(zzo zzo) {
        ...
        try {
            ...
            this.zza.zzj().zzg().zza("Failed to get consent. appId", zzfr.zza(zzo.zza), e10);
            return new zzam((Bundle) null);
        }
    }
    ...
    public final zzbg zzb(zzbg zzbg, zzo zzo) {
        zzbb zzbb;
        boolean z10 = false;
        if (!(!"_cmp".equals(zzbg.zza) || (zzbb = zzbg.zzb) == null || zzbb.zza() == 0)) {
    ...
    public final void zzc(zzbg zzbg, zzo zzo) {
        ...
        try {
            ...
            z10 = zzb2.zza(new zzad(zza3, zzbg.zzd, zza2));
        } catch (zzc unused) {
    ...
    private final void zzb(zzo zzo, boolean z10) {
    ...
    public final List<zzmh> zza(zzo zzo, Bundle bundle) {
        ...
        try {
            ...
            this.zza.zzj().zzg().zza("Failed to get trigger URIs. appId", zzfr.zza(zzo.zza), e10);
            return Collections.emptyList();
        }
    }

    public final List<zznc> zza(zzo zzo, boolean z10) {
        zzb(zzo, false);
        String str = zzo.zza;
        ...
        try {
            ...
            for (zzne zzne : list) {
                if (z10 || !zznd.zzg(zzne.zzc)) {
                    arrayList.add(new zznc(zzne));
                }
            }
            return arrayList;
        } catch (InterruptedException | ExecutionException e10) {
            this.zza.zzj().zzg().zza("Failed to get user properties. appId", zzfr.zza(zzo.zza), e10);
            return null;
        }
    }
    ...
    public final List<zznc> zza(String str, String str2, boolean z10, zzo zzo) {
        zzb(zzo, false);
        String str3 = zzo.zza;
        Preconditions.checkNotNull(str3);
        try {
            ...
            this.zza.zzj().zzg().zza("Failed to query user properties. appId", zzfr.zza(zzo.zza), e10);
            return Collections.emptyList();
        }
    }
    ...
    public final List<zznc> zza(String str, String str2, String str3, boolean z10) {
        ...
        try {
            ...
            this.zza.zzj().zzg().zza("Failed to get user properties as. appId", zzfr.zza(str), e10);
            return Collections.emptyList();
        }
    }
    ...
    public final void zza(long j10, String str, String str2, String str3) {
        zza((Runnable) new zzhn(this, str2, str3, str, j10));
    }
    ...
    public final byte[] zza(zzbg zzbg, String str) {
        ...
        try {
            ...
            this.zza.zzj().zzg().zza("Failed to log and bundle. appId, event, error", zzfr.zza(str), this.zza.zzg().zza(zzbg.zza), e10);
            return null;
        }
    }
}
