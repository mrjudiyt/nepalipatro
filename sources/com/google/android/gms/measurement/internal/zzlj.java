...
final class zzlj implements Runnable {
    ...
    zzlj(zzkp zzkp, AtomicReference atomicReference, String str, String str2, String str3, zzo zzo, boolean z10) {
        this.zzg = zzkp;
    ...
    public final void run() {
        synchronized (this.zza) {
            try {
                ...
                try {
                    this.zzg.zzj().zzg().zza("(legacy) Failed to get user properties; remote exception", zzfr.zza(this.zzb), this.zzc, e10);
                    this.zza.set(Collections.emptyList());
                    this.zza.notify();
                } catch (Throwable th) {
                    this.zza.notify();
