...
final class zzt extends zzmo {
    ...
    public final java.util.List<com.google.android.gms.internal.measurement.zzfi.zzc> zza(java.lang.String r53, java.util.List<com.google.android.gms.internal.measurement.zzfi.zze> r54, java.util.List<com.google.android.gms.internal.measurement.zzfi.zzn> r55, java.lang.Long r56, java.lang.Long r57) {
        ...
        L_0x0667:
            ...
            r6.put(r0, r3)
            android.database.sqlite.SQLiteDatabase r0 = r4.e_()     // Catch:{ SQLiteException -> 0x06e5 }
            ...
            com.google.android.gms.measurement.internal.zzfr r0 = r4.zzj()     // Catch:{ SQLiteException -> 0x06e3 }
            com.google.android.gms.measurement.internal.zzft r0 = r0.zzg()     // Catch:{ SQLiteException -> 0x06e3 }
            java.lang.String r3 = "Failed to insert filter results (got -1). appId"
            java.lang.Object r6 = com.google.android.gms.measurement.internal.zzfr.zza((java.lang.String) r5)     // Catch:{ SQLiteException -> 0x06e3 }
            r0.zza(r3, r6)     // Catch:{ SQLiteException -> 0x06e3 }
            goto L_0x0667
        L_0x06e3:
            r0 = move-exception
            goto L_0x06e7
    ...
    private final boolean zza(int i10, int i11) {
        zzv zzv = this.zzc.get(Integer.valueOf(i10));
        if (zzv == null) {
            return false;
        }
        return zzv.zzd.get(i11);
    }
}
