...
public final class zzkh extends zze {
    ...
    static /* synthetic */ void zza(zzkh zzkh, Bundle bundle, zzki zzki, zzki zzki2, long j10) {
        if (bundle != null) {
            bundle.remove(FirebaseAnalytics.Param.SCREEN_NAME);
            bundle.remove(FirebaseAnalytics.Param.SCREEN_CLASS);
        }
        zzkh.zza(zzki, zzki2, j10, true, zzkh.zzq().zza((String) null, FirebaseAnalytics.Event.SCREEN_VIEW, bundle, (List<String>) null, false));
    }

    private final void zza(Activity activity, zzki zzki, boolean z10) {
        zzki zzki2;
        zzki zzki3 = zzki;
        ...
        this.zzc = this.zzb;
        this.zzb = zzki2;
        zzl().zzb((Runnable) new zzkm(this, zzki2, zzki4, zzb().elapsedRealtime(), z10));
    }
    ...
    /* access modifiers changed from: private */
    public final void zza(zzki zzki, zzki zzki2, long j10, boolean z10, Bundle bundle) {
        Bundle bundle2;
        long j11;
        zzki zzki3 = zzki;
        zzki zzki4 = zzki2;
        ...
        zzt();
        boolean z11 = false;
        boolean z12 = zzki4 == null || zzki4.zzc != zzki3.zzc || !zzkk.zza(zzki4.zzb, zzki3.zzb) || !zzkk.zza(zzki4.zza, zzki3.zza);
        ...
        if (z12) {
            ...
            if (zzki4 != null) {
                String str = zzki4.zza;
                if (str != null) {
                    bundle4.putString("_pn", str);
                }
                String str2 = zzki4.zzb;
                if (str2 != null) {
            ...
            String str3 = zzki3.zze ? "app" : "auto";
            long currentTimeMillis = zzb().currentTimeMillis();
            if (zzki3.zze) {
                long j13 = zzki3.zzf;
                if (j13 != 0) {
                    j11 = j13;
                    zzm().zza(str3, "_vs", j11, bundle4);
                }
            }
    ...
    /* access modifiers changed from: private */
    public final void zza(zzki zzki, boolean z10, long j10) {
        zzc().zza(zzb().elapsedRealtime());
        if (zzp().zza(zzki != null && zzki.zzd, z10, j10) && zzki != null) {
            zzki.zzd = false;
        }
    }
