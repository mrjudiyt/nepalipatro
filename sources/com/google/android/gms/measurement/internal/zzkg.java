            ...
            if (zzd == null) {
                ...
                try {
                    ...
                    for (int i10 = 0; i10 < zzi2.size(); i10++) {
                        zzfi.zzn.zza zzb3 = zzfi.zzn.zze().zza(zzi2.get(i10).zzc).zzb(zzi2.get(i10).zzd);
                        g_().zza(zzb3, zzi2.get(i10).zze);
                        zznArr[i10] = (zzfi.zzn) ((zzix) zzb3.zzab());
                    }
                    ...
                    zzh().zza(zzbc);
                    zzaz zzaz = new zzaz(this.zzu, zzbg2.zzc, str, zzbg2.zza, zzbg2.zzd, j10, bundle);
                    ...
                    zzh.zzai();
                    zza7.zzf((int) zzh.zzq()).zzl(82001).zzk(zzb().currentTimeMillis()).zzd(true);
                    ...
                    try {
                        ...
                        zzj().zzg().zza("Data loss. Failed to bundle and serialize. appId", zzfr.zza(str), e11);
                        return bArr;
                    }
