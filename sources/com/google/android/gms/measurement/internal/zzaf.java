...
public final class zzaf extends zzid {
    ...
    public final boolean zzf(String str, zzfi<Boolean> zzfi) {
        ...
        return zzfi.zza(Boolean.valueOf(AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(zza2))).booleanValue();
    }
    ...
    public final int zza(String str, zzfi<Integer> zzfi, int i10, int i11) {
        return Math.max(Math.min(zzb(str, zzfi), i11), i10);
    }
