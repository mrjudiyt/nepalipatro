...
public final class zziq extends zze {
    ...
    public final void zzap() {
        ...
        if (zza2 != null) {
            if ("unset".equals(zza2)) {
                ...
                zza("app", "_npa", (Object) Long.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(zza2) ? 1 : 0), zzb().currentTimeMillis());
            }
        }
    ...
    public final void zzan() {
        ...
        if (!zzao().isEmpty() && !this.zzh && (poll = zzao().poll()) != null && (zzn2 = zzq().zzn()) != null) {
            ...
            e<q> d10 = zzn2.d(Uri.parse(poll.zza));
            if (d10 == null) {
                this.zzh = false;
                zzao().add(poll);
                return;
            ...
            for (int i10 = 0; i10 < zzg2.size(); i10++) {
                iArr[i10] = zzg2.keyAt(i10);
                jArr[i10] = zzg2.valueAt(i10).longValue();
            }
            Bundle bundle = new Bundle();
            bundle.putIntArray("uriSources", iArr);
            bundle.putLongArray("uriTimestamps", jArr);
            zzk2.zzi.zza(bundle);
            c.a(d10, new zzjc(this, poll), new zziz(this));
        }
    }
    ...
    private final void zzb(String str, String str2, long j10, Bundle bundle, boolean z10, boolean z11, boolean z12, String str3) {
        zzl().zzb((Runnable) new zzjg(this, str, str2, j10, zznd.zza(bundle), z10, z11, z12, str3));
    }
    ...
    public final List<zznc> zza(boolean z10) {
        zzu();
        ...
        if (zzl().zzg()) {
            ...
            AtomicReference atomicReference = new AtomicReference();
            this.zzu.zzl().zza(atomicReference, 5000, "get user properties", new zzji(this, atomicReference, z10));
    ...
    public final Map<String, Object> zza(String str, String str2, boolean z10) {
        if (zzl().zzg()) {
            ...
            AtomicReference atomicReference = new AtomicReference();
            this.zzu.zzl().zza(atomicReference, 5000, "get user properties", new zzjn(this, atomicReference, (String) null, str, str2, z10));
            List<zznc> list = (List) atomicReference.get();
            if (list == null) {
    ...
    static /* synthetic */ void zza(zziq zziq, zzih zzih, zzih zzih2) {
        zzih.zza zza2 = zzih.zza.ANALYTICS_STORAGE;
        zzih.zza zza3 = zzih.zza.AD_STORAGE;
        boolean zza4 = zzih.zza(zzih2, zza2, zza3);
        boolean zzb2 = zzih.zzb(zzih2, zza2, zza3);
        if (zza4 || zzb2) {
            zziq.zzg().zzag();
        }
    }

    static /* synthetic */ void zza(zziq zziq, zzih zzih, long j10, boolean z10, boolean z11) {
        zziq.zzt();
        zziq.zzu();
        zzih zzm2 = zziq.zzk().zzm();
        if (j10 <= zziq.zzl && zzih.zza(zzm2.zza(), zzih.zza())) {
    ...
    public final void zza(String str, String str2, Bundle bundle, boolean z10, boolean z11, long j10) {
        ...
        long j11 = j10;
        zzb(str4, str2, j10, bundle2, z11, !z11 || this.zzc == null || zznd.zzg(str2), z10, (String) null);
    }
    ...
    public final void zza(String str, String str2, long j10, Bundle bundle) {
        zzt();
        zza(str, str2, j10, bundle, true, this.zzc == null || zznd.zzg(str2), true, (String) null);
    }
        ...
        if (zzaf == null || zzaf.contains(str9)) {
            ...
            if (!z12 && !"_iap".equals(str9)) {
                ...
                if (i11 != 0) {
                    ...
                    this.zzu.zzt();
                    zznd.zza(this.zzo, i11, "_ev", zza2, i10);
                    return;
                }
            }
            ...
            zznd.zza(zza3, bundle2, z10 && !z12);
            boolean equals = "am".equals(str8);
            boolean zzg2 = zznd.zzg(str2);
            if (z10 && this.zzc != null && !zzg2 && !equals) {
                ...
                if (zza4 != 0) {
                    ...
                    this.zzu.zzt();
                    zznd.zza(this.zzo, str3, zza4, "_ev", zza5, i10);
                    return;
                }
                Bundle zza6 = zzq().zza(str3, str2, bundle, (List<String>) CollectionUtils.listOf((T[]) new String[]{"_o", "_sn", "_sc", "_si"}), z12);
                ...
                if (zzn().zza(false) != null && Constants.FIREBASE_APPLICATION_EXCEPTION.equals(str9)) {
                    ...
                    long j13 = elapsedRealtime - zzmd.zza;
                ...
                if (zzk().zzk.zza() <= 0 || !zzk().zza(j12) || !z13) {
                    j11 = 0;
                ...
                while (i13 < arrayList.size()) {
                    ...
                    zzo().zza(new zzbg(str6, new zzbb(bundle4), str, j10), str3);
                    if (!equals) {
                        for (zzil onEvent : zziq.zzd) {
                            onEvent.onEvent(str, str2, new Bundle(bundle4), j10);
                            String str11 = str3;
                        }
                    }
                    i13++;
    ...
    private final void zza(String str, String str2, long j10, Object obj) {
        zzl().zzb((Runnable) new zzjf(this, str, str2, obj, j10));
    }
    ...
    public final void zza(Bundle bundle, long j10) {
        ...
        zzie.zza(bundle2, "app_id", cls2, null);
        zzie.zza(bundle2, "origin", cls2, null);
        zzie.zza(bundle2, "name", cls2, null);
        zzie.zza(bundle2, "value", Object.class, null);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, cls2, null);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT, cls, 0L);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, cls2, null);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, null);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, cls2, null);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, null);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE, cls, 0L);
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, cls2, null);
    ...
    public final void zza(zzih zzih, long j10) {
        zzih zzih2;
        boolean z10;
        boolean z11;
        boolean z12;
        ...
        if (z11) {
            zza((String) null);
            zzl().zzc((Runnable) new zzjv(this, zzih3, j10, andIncrement, z12, zzih2));
            return;
        }
        zzjy zzjy = new zzjy(this, zzih3, andIncrement, z12, zzih2);
        if (zza2 == 30 || zza2 == -10) {
    ...
    public final void zza(Bundle bundle, int i10, long j10) {
        ...
        zzay zza4 = zzay.zza(bundle, i10);
        if (zza4.zzg()) {
            zza(zza4);
        }
        Boolean zza5 = zzay.zza(bundle);
        if (zza5 != null) {
            zza("app", FirebaseAnalytics.UserProperty.ALLOW_AD_PERSONALIZATION_SIGNALS, (Object) zza5.toString(), false);
        }
    }
    ...
    public final void zza(zzih zzih) {
        zzt();
        boolean z10 = (zzih.zzh() && zzih.zzg()) || zzo().zzaj();
        if (z10 != this.zzu.zzad()) {
            this.zzu.zzb(z10);
            Boolean zzp = zzk().zzp();
            if (!z10 || zzp == null || zzp.booleanValue()) {
    ...
    public final void zza(String str, String str2, Object obj, boolean z10, long j10) {
        ...
        if (i10 != 0) {
            ...
            this.zzu.zzt();
            zznd.zza(this.zzo, i10, "_ev", zza2, i11);
        } else if (obj != null) {
            ...
            if (zza3 != 0) {
                ...
                this.zzu.zzt();
                zznd.zza(this.zzo, zza3, "_ev", zza4, i11);
                return;
            }
            Object zzc2 = zzq().zzc(str2, obj);
            if (zzc2 != null) {
                zza(str3, str2, j10, zzc2);
            }
        } else {
