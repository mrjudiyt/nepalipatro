...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    ProxyResponse(@SafeParcelable.Param(id = 1000) int i10, @SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(id = 3) int i12, @SafeParcelable.Param(id = 4) Bundle bundle, @SafeParcelable.Param(id = 5) byte[] bArr) {
        this.zza = i10;
    ...
    public ProxyResponse(int i10, Map<String, String> map, byte[] bArr) {
        this(1, 0, (PendingIntent) null, i10, zza(map), bArr);
    }
}
