...
public class zzl {
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzk, long j10) {
        ...
        try {
            ...
            String.format("SecurityException while bind to auth service: %s", new Object[]{e11.getMessage()});
    ...
    /* access modifiers changed from: private */
    public static Object zzj(Object obj) {
        if (obj != null) {
            return obj;
        }
