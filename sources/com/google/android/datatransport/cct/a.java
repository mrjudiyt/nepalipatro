...
public final class a implements g {
    ...
    static final String f6187c;

    /* renamed from: d  reason: collision with root package name */
    static final String f6188d;

    /* renamed from: e  reason: collision with root package name */
    private static final String f6189e;

    /* renamed from: f  reason: collision with root package name */
    private static final Set<b> f6190f = Collections.unmodifiableSet(new HashSet(Arrays.asList(new b[]{b.b("proto"), b.b("json")})));

    /* renamed from: g  reason: collision with root package name */
    public static final a f6191g;
    ...
    static {
        ...
        f6189e = a12;
        f6191g = new a(a10, (String) null);
        f6192h = new a(a11, a12);
    }
    ...
    public byte[] c() {
        ...
        if (str == null && this.f6193a == null) {
            return null;
        }
        Object[] objArr = new Object[4];
        objArr[0] = "1$";
        objArr[1] = this.f6193a;
        objArr[2] = "\\";
        if (str == null) {
            str = "";
        }
