...
public final class i0 {
    ...
    static int b(int i10) {
        i.b(i10, "arraySize");
        return d.j(((long) i10) + 5 + ((long) (i10 / 10)));
    }
    ...
    static boolean c(List<?> list, Object obj) {
        ...
        if (!(list instanceof RandomAccess) || !(list2 instanceof RandomAccess)) {
            return g0.c(list.iterator(), list2.iterator());
        }
        for (int i10 = 0; i10 < size; i10++) {
            if (!l.a(list.get(i10), list2.get(i10))) {
                return false;
            }
        }
        return true;
    ...
    static int f(List<?> list, Object obj) {
        ...
        while (listIterator.hasPrevious()) {
            if (l.a(obj, listIterator.previous())) {
