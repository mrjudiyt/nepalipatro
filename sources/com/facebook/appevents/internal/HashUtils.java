...
public final class HashUtils {
    ...
    public static final String computeChecksumWithPackageManager(Context context, Long l10) {
        ...
        try {
            ...
            m.e(method, "PackageManager::class\n              .java\n              .getMethod(\n                  \"requestChecksums\",\n                  String::class.java,\n                  Boolean::class.javaPrimitiveType,\n                  Int::class.javaPrimitiveType,\n                  MutableList::class.java,\n                  checksumReadyListenerClass)");
            method.invoke(context.getPackageManager(), new Object[]{context.getPackageName(), Boolean.FALSE, obj, x.T(T), newProxyInstance});
            if (l10 == null) {
                newCondition.await();
            } else {
                newCondition.awaitNanos(l10.longValue());
            }
            String str = (String) yVar.f15575h;
    ...
    private final java.lang.String computeFileMd5(java.io.File r5) {
        /*
            r4 = this;
        ...
        L_0x001e:
            ...
            kotlin.jvm.internal.m.e(r5, r1)     // Catch:{ all -> 0x003b }
            r1 = 0
            w8.b.a(r0, r1)
            return r5
        L_0x003b:
