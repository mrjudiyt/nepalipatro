...
public class AdView extends RelativeLayout implements Ad {
    ...
    public AdView(Context context, String str, AdSize adSize) {
        super(context);
        AnonymousClass1 r42 = new AdViewParentApi() {
            @Benchmark
            public void onConfigurationChanged(Configuration configuration) {
                AdView.super.onConfigurationChanged(configuration);
            }
        };
        this.mAdViewParentApi = r42;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, adSize, (AdViewParentApi) r42, this);
    }
    ...
    public AdView(Context context, String str, String str2) {
        ...
        this.mAdViewParentApi = r42;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, str2, (AdViewParentApi) r42, this);
    }
}
